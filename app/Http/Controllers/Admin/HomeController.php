...
class HomeController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return redirect('/admin/login')->with('error', 'Configuration incomplète. Veuillez contacter l\'administrateur.');
        }
        ...
        return view('admin.aurora-dashboard', compact(
            'order_counter',
            'id',
            'store_id',
            'user_counter',
    ...
    private function getWeeklySalesData($tableName, $dateColumn, $revenueColumn, $commissionColumn, $salesColumn, $store_id)
    {
        ...
        $weekWiseSales = [
            'total_revenue' => array_fill(0, 7, 0),
