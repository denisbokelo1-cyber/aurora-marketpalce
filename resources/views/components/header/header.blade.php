        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="logo col-5 col-sm-3 col-md-3 col-lg-2 align-self-center">
                    <a wire:navigate class="logoImg" href="{{ customUrl('home') }}"><img src="{{ asset('logo.png') }}"
                            alt="AURORA MARKETPLACE" title="AURORA MARKETPLACE" style="height: 40px; width: auto; max-width: 160px; object-fit: contain;" /></a>
                </div>
                <!--End Logo-->
                <!--Menu-->
