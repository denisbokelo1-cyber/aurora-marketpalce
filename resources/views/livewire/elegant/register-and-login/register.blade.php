                ...
                <div class="col-12 col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                    <div class="inner h-100">
                        <div class="text-center mb-3">
                            <a wire:navigate href="{{ customUrl('/') }}">
                                <img src="{{ asset('frontend/elegant/images/logo.svg') }}" alt="Aurora Marketplace" style="max-height:50px;" onerror="this.style.display='none';this.nextElementSibling.style.display='block'">
                                <h3 style="display:none;color:#F57C00;font-weight:800;font-size:1.5rem;margin:0;">Aurora Marketplace</h3>
                            </a>
                        </div>
                        <h2 class="text-center fs-4 mb-4">
                            {{ labels('front_messages.register', 'Inscription') }}
                        </h2>
                        ...
                        @if (($system_settings['google'] ?? 0) == 1 || ($system_settings['facebook'] ?? 0) == 1)
