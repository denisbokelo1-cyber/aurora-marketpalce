                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-6 d-flex justify-content-end mt-sm-2">
                                <div class="input-group me-2 search-input-grp ">
                                    ...
                                    <input type="text" data-table="admin_theme_table" class="aurora-input" style="max-width:200px;display:inline-block"
                                ...
                                <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_theme_table"><i
