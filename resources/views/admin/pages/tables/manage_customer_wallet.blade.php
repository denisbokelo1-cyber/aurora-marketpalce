...
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.wallet_transaction', 'Wallet Transaction')" :subtitle="labels(
        ...
        ['label' => labels('admin_labels.customers', 'Clients')],
    ...
    <div class="aurora-modal-overlay" style="display:none" id="add_wallet_transaction" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                ...
                <form class="submit_form" method="POST" action="{{ route('admin.customers.updateCustomerWallet') }}"
                    ...
                    <div class="aurora-modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" min=1 class="aurora-input" id="amount" placeholder="{{ labels('admin_labels.enter_amount', 'Enter Amount') }}"
                                name="amount">
                        </div>
                        <div class="col-md-12">
                            <label for="message"
                                class=" col-form-label">{{ labels('admin_labels.message', 'Message') }}</label>
                            <textarea class="aurora-input" id="message" placeholder="{{ labels('admin_labels.enter_message_here', 'Enter Message Here') }}" name="message"></textarea>
                        </div>
                    </div>
    ...
    <div class="aurora-modal-overlay" style="display:none" id="transaction_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="aurora-modal-header">
                    ...
                    <div class="aurora-modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-control form-select" name="status" id="t_status">
                                ...
                                <option value="success"> {{ labels('admin_labels.success_status', 'Succès') }} </option>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="aurora-input" name="txn_id" id="txn_id"
                                placeholder="txn_id" />
                        </div>
                        <div class="col-md-12">
                            <label for="message"
                                class="mb-2 mt-2">{{ labels('admin_labels.message', 'Message') }}</label>
                            <input type="text" class="aurora-input" name="message" id="transaction_message"
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xxl-6 d-flex justify-content-end ">
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_customer_wallet_table"><i
