...
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.sellers', 'Vendeurs')" :subtitle="labels(
        'admin_labels.efficiently_organize_and_manage_sellers',
        'Efficiently Organize and Manage Sellers',
    )" :breadcrumbs="[['label' => labels('admin_labels.sellers', 'Vendeurs')]]" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 d-flex justify-content-end mt-md-2 mt-sm-2">
                            ...
                            <div class="input-group me-2 search-input-grp ">
                                ...
                                <input type="text" data-table="admin_manage_sellers" class="aurora-input" style="max-width:200px;display:inline-block"
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_manage_sellers"><i
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="operate" data-sortable='false'>
                                            {{ labels('admin_labels.action', 'Actions') }}</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
