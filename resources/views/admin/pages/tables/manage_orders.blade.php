...
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.manage_orders', 'Manage Orders')" :subtitle="labels('admin_labels.all_information_about_orders', 'All Information About Orders')" :breadcrumbs="[
        ...
        ['label' => labels('admin_labels.orders', 'Commandes')],
    ]" />
    @php
            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-4 col-md-6 col-sm-12 col">
                    <div class="info-box align-items-center">
                        ...
                        <div class="content">
                            <p class="body-default">{{ labels('admin_labels.delivered', 'Livrée') }}</p>
                ...
                <div class="col-xxl-4 col-lg-4 col-md-6 col-sm-12 col">
                    <div class="info-box align-items-center">
                        ...
                        <div class="content">
                            <p class="body-default">{{ labels('admin_labels.cancelled', 'Annulée') }}</p>
                ...
                <div class="col-xxl-4 col-lg-4 col-md-6 col-sm-12 col">
                    <div class="info-box align-items-center">
                        ...
                        <div class="content">
                            <p class="body-default">{{ labels('admin_labels.returned', 'Retournée') }}</p>
    ...
    <div class="aurora-modal-overlay" style="display:none" id="order-tracking-modal" tabindex="-1" role="dialog"
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12 d-flex justify-content-end ">
                                            ...
                                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_order_tracking_table"><i
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal " id="order_tracking_form"
                    ...
                    <div class="aurora-modal-footer">
                        <button type="reset"
                            class="aurora-btn aurora-btn-warning">{{ labels('admin_labels.reset', 'Réinitialiser') }}</button>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex justify-content-end ">
                            ...
                            <div class="input-group me-2 search-input-grp ">
                                <span class="search-icon"><i class='bx bx-search-alt'></i></span>
                                <input type="text" data-table="admin_order_table" class="aurora-input" style="max-width:200px;display:inline-block"
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_order_table"><i
                                    class='bx bx-refresh'></i></a>
                            <div class="dropdown">
