...
@section('title')
    {{ labels('admin_labels.manage_stores', 'Gérer les boutiques') }}
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.manage_stores', 'Gérer les boutiques')" :subtitle="labels('admin_labels.track_and_manage_stores', 'Track and Manage Stores')" :breadcrumbs="[
        ['label' => labels('admin_labels.stores', 'Boutiques'), 'url' => route('admin.stores.index')],
        ['label' => labels('admin_labels.manage_stores', 'Gérer les boutiques')],
    ]" />
        ...
        <div class="card content-area p-4 ">
            <div class="aurora-flex-between aurora-mb-4">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <h4>{{ labels('admin_labels.manage_stores', 'Gérer les boutiques') }}
                            </h4>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end ">
                            <div class="input-group me-2 search-input-grp ">
                                <span class="search-icon"><i class='bx bx-search-alt'></i></span>
                                <input type="text" data-table="admin_stores_list" class="aurora-input" style="max-width:200px;display:inline-block"
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_stores_list"><i
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="is_default_store" data-sortable="false">
                                            {{ labels('admin_labels.is_default_store', 'Boutique par défaut') }}
                                        </th>
