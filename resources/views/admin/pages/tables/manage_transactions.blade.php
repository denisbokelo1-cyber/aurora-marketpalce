...
@section('content')
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex justify-content-end ">
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_customer_transaction_table"><i
    ...
    <div class="aurora-modal-overlay" style="display:none" id="transaction_modal" tabindex="-1" role="dialog"
