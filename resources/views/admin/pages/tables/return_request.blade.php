...
@section('content')
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-6 d-flex justify-content-end ">
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_return_request_table"><i
    ...
    <div class="aurora-modal-overlay" style="display:none" id="request_request_modal" tabindex="-1" role="dialog"
                ...
                <form class="form-horizontal submit_form" action="{{ route('admin.return_request.update') }}"
                    ...
                    <div class="aurora-modal-body">
                        <div class="form-group">
                            <label for=""
                                class="control-label col-md-3 col-sm-3 col-xs-12">{{ labels('admin_labels.status', 'Statut') }}
                                <span class='text-asterisks text-sm'>*</span></label>
                            <div class="col-md-7 col-sm-6 col-xs-12">
                                <div id="status" class="btn-group">
                                    <label class="aurora-btn aurora-btn-warning mx-2" data-toggle-class="btn-primary"
