...
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.manage_language', 'Manage Language')" :subtitle="labels('admin_labels.track_and_manage_Languages', 'Track and Manage Languages')" :breadcrumbs="[
        ['label' => labels('admin_labels.languages', 'Langues')],
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex justify-content-end ">
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_manage_language_table"><i
                ...
                <div class="col-md-12">
                    <div class="pt-0">
                        <div class="table-responsive">
                            <table class="aurora-table" id="admin_manage_language_table" data-toggle="table"
    ...
    <!-- Edit Language Modal -->
    <div class="aurora-modal-overlay" style="display:none" id="editLanguageModal" tabindex="-1" aria-labelledby="editLanguageModalLabel"
        aria-hidden="true">
                ...
                <div class="aurora-modal-body">
                    <form id="editLanguageForm" action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="aurora-input" id="language_name" name="language">
                        </div>
                        <button type="submit" class="aurora-btn aurora-btn-primary">Save Changes</button>
                    </form>
                </div>
            </div>
        </div>
