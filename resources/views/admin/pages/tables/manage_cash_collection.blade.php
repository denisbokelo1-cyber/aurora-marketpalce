...
@section('content')
    ...
    <div class="aurora-modal-overlay" style="display:none" id="cash_collection_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                ...
                <form class="submit_form" action="{{ route('admin.manage_cash_collection') }}" method="POST"
                    ...
                    <div class="aurora-modal-body">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="text" name="amount" id="amount" class="aurora-input"
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="datetime-local" name="date" id="date" class="aurora-input"
                                value="{{ date('Y-m-d') }}">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="aurora-input" rows="3" name="message" id="message"></textarea>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-xl-8 d-flex justify-content-end">
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_delivery_boy_cash_collection"><i
