...
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-6 d-flex justify-content-end mt-sm-2">
                                <div class="input-group me-2 search-input-grp ">
                                    ...
                                    <input type="text" data-table="admin_ticket_table" class="aurora-input" style="max-width:200px;display:inline-block"
                                ...
                                <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_ticket_table"><i
    ...
    <div class="aurora-modal-overlay" style="display:none" id="ticket_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                            ...
                            <div class="aurora-card-footer">
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" name="user_type" id="user_type">
                                        <input type="hidden" name="ticket_id" id="ticket_id">
                                        <input type="text" class="aurora-input" name="message" id="message_input"
