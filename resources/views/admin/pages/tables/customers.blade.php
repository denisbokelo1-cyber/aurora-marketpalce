...
@section('title')
    {{ labels('admin_labels.customers', 'Clients') }}
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.customers', 'Clients')" :subtitle="labels('admin_labels.optimize_and_manage_customers', 'Optimize and Manage Customers')" :breadcrumbs="[['label' => labels('admin_labels.customers', 'Clients')]]" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 d-flex justify-content-end ">
                                <div class="input-group me-2 search-input-grp ">
                                    ...
                                    <input type="text" data-table="admin_customer_table" class="aurora-input" style="max-width:200px;display:inline-block"
                                ...
                                <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_customer_table"><i
    ...
    <div class="aurora-modal-overlay" style="display:none" id="customer-address-modal" tabindex="-1" role="dialog"
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12 d-flex justify-content-end ">
                                            ...
                                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="customer-address-table"><i
                                                    class='bx bx-refresh'></i></a>
                                            <div class="dropdown">
                                                ...
                                                <ul class="aurora-dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                    <li><a class="aurora-dropdown-item" href="#"
