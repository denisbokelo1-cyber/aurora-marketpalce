                    ...
                    <div class="card-body ">
                        ...
                        <div class="tab-content mt-3" id="brandTabsContent">
                            <div class="" id="content-en" role="tabpanel" aria-labelledby="tab-en">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="aurora-input" name="short_description"
                        ...
                        <div class="form-group row select-categories">
                            <label for="categories"
                                class="control-label mb-2 mt-2">{{ labels('admin_labels.categories', 'Catégories') }}</label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group row custom_products d-none">
                            <label for="product_ids"
                                class="control-label mb-2 mt-2">{{ labels('admin_labels.products', 'Produits') }}
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end mt-md-2 mt-lg-0">
                                ...
                                <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_featured_section_table"><i
