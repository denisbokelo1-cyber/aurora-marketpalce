                ...
                <form class="form-horizontal submit_form" id="order_tracking_form"
                    ...
                    <div class="aurora-modal-body">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="aurora-input" name="url" id="url" placeholder="{{ labels('admin_labels.url_text', 'URL') }}" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="admin_order_items_table" class="aurora-table" data-toggle="table"
