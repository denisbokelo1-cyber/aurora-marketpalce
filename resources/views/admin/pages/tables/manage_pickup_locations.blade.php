...
@section('content')
    ...
    <section class="overview-data {{ $user_role == 'super_admin' || 'view pickup_location' ? '' : 'd-none' }}">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-end ">
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_pickup_locaton_table"><i
                ...
                <div class="modal-content">
                    ...
                    <form enctype="multipart/form-data" method="POST" class="submit_form">
                        ...
                        <div class="aurora-modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name"
                                            class="form-label mb-2 mt-2">{{ labels('admin_labels.name', 'Nom') }}
                                            <span class='text-asterisks text-sm'>*</span></label>
                        ...
                        <div class="aurora-modal-footer">
                            ...
                            <button type="submit"
                                class="aurora-btn aurora-btn-primary">{{ labels('admin_labels.edit_pickup_location', 'Update Pickup Location') }}</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="aurora-modal-overlay" style="display:none" id="verifyPickupLocations" tabindex="-1" role="dialog"
