...
@section('content')
    ...
    <div class="card m-2 tab-pane" id="firebase_setting">
        <div class="aurora-card-body">
            ...
            <nav>
                <div class="aurora-tabs" id="nav-tab" role="tablist">
            ...
            <div class="" id="nav-tabContent">
                <div class="" id="nav-sms-gateway" role="tabpanel"
                            ...
                            <form class="form-horizontal form-submit-event smsgateway_setting_form" action=""
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="aurora-input" id="base_url" name="base_url"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select id="sms_gateway_method" class="aurora-input" name="sms_gateway_method">
                                            <option value="POST"
                                ...
                                <div class="py-3">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" id="converterInputAccountSID" class="aurora-input">
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label for="converterInputAuthToken" class="form-label">
                                                {{ labels('admin_labels.auth_token', 'Auth Token') }}
                                            </label>
                                            <input type="text" id="converterInputAuthToken" class="aurora-input">
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <div class="col-md-4 mb-3">
                                            <button type="button" onClick="createHeader()" class="aurora-btn aurora-btn-primary">Create
                                                Token</button>
                                        </div>
                                        <div class="col-md-12">
                                            <h4 id="basicToken"></h4>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="" id="nav-tabContent">
                                        <!-- header -->
                                        <div class="" id="product-header" role="tabpanel"
                                        ...
                                        <!-- product body tab -->
                                        <div class="" id="product-body" role="tabpanel"
                                            aria-labelledby="product-body-tab">
                                            <div class="row">
                                                <ul class="aurora-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link sms_gateway_nav_link sms_gateway_tab active"
                                        ...
                                        <div class="" id="product-params" role="tabpanel"
                                    ...
                                    <div class="tab-content p-3 w-100" id="nav-tabContent">
                                        <!-- product faq tab -->
                                        <div class="" id="product-text" role="tabpanel"
                                        ...
                                        <div class="" id="product-formdata" role="tabpanel"
