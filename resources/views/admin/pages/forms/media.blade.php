...
<section class="">
    <div class="card content-area p-4">
        ...
        <div class="mt-4 col-md-12 additional-info-nav-header d-flex">
            <div class="col-md-8">
                <nav class="w-100">
                    <div class="aurora-tabs" id="media-tab" role="tablist">
            ...
            <div class="col-md-4">
                <div class="align-items-center d-flex form-group justify-content-end gap-3">
                    <div class="col-md-6">
                        <select class="aurora-input" id="media-type">
                    ...
                    <div class="input-group search-input-grp product-search">
                        ...
                        <input type="text" name="search_products" class="aurora-input" id="search_products"
        ...
        <div class="tab-content p-3 col-md-12 {{ $user_role == 'super_admin' || $logged_in_user->hasPermissionTo('view media') ? '' : 'd-none' }}"
                    ...
                    <div class="row media-card-container">
                        ...
                        @if($media->isEmpty())
                            <div class="col-12 d-flex justify-content-center mt-5">
                                <p class="aurora-text-muted">{{ labels('admin_labels.no_media_found', 'No media found!!') }}</p>
                            </div>
                        @else
                                ...
                                <div class="col-md-6 col-xl-3 col-xxl-2 col-sm-6 mt-5">
                                    <div class="media-card">
                                        ...
                                        <div class="media-details d-flex justify-content-between">
                                            <p class="aurora-text-muted">{{ $row->size }} KB</p>
                                            <div class="d-flex">
            ...
            <div class="" id="media-upload" role="tabpanel" aria-labelledby="media-upload-tab">
                <form action="{{ route('admin.media.upload') }}" class="submit_form" enctype="multipart/form-data"
                    ...
                    <input type="file" class="filepond" name="documents[]" multiple data-max-file-size="30MB"
                        data-max-files="20" />
                    <button type="submit"
                        class="btn btn-primary submit_button float-end">{{ labels('admin_labels.upload', 'Télécharger') }}</button>
                </form>
            </div>
