        ...
        <div class="col-md-12">
            <form id="general_setting_form" action="{{ route('web_settings.store') }}" class="submit_form"
                        ...
                        <div class="aurora-card">
                            <div class="aurora-card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="card-body d-flex justify-content-end">
                                            <a class="toggle form-switch me-1 mb-1" title="{{ labels('admin_labels.title_deactivate', 'Deactivate') }}"
                                                ...
                                                <input type="checkbox" id="app_download_section"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="aurora-input" name="app_download_section_title"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="aurora-input" name="app_download_section_tagline"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="aurora-input" name="app_download_section_playstore_url"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="aurora-input" name="app_download_section_appstore_url"
                                ...
                                <div class="form-group col-md-12">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="card-body d-flex justify-content-end">
                                            <a class="toggle form-switch me-1 mb-1" title="{{ labels('admin_labels.title_deactivate', 'Deactivate') }}"
                                                href="javascript:void(0)">
                                                <input type="checkbox" id="support_mode"
                                                    name="support_mode"
                                ...
                                <div class="form-group col-md-12">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="card-body d-flex justify-content-end">
                                            <a class="toggle form-switch me-1 mb-1" title="{{ labels('admin_labels.title_deactivate', 'Deactivate') }}"
                                                href="javascript:void(0)">
                                                <input type="checkbox" id="shipping_mode"
                                                    name="shipping_mode"
                        ...
                        <div class="aurora-card">
                            <div class="aurora-card-body">
                                <div class="form-group col-md-12">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="card-body d-flex justify-content-end">
                                            <a class="toggle form-switch me-1 mb-1" title="{{ labels('admin_labels.title_deactivate', 'Deactivate') }}"
                                                href="javascript:void(0)">
                                                <input type="checkbox" id="safety_security_mode"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="aurora-input" name="safety_security_title"
                                ...
                                <div class="form-group col-md-12">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="card-body d-flex justify-content-end">
                                            <a class="toggle form-switch me-1 mb-1" title="{{ labels('admin_labels.title_deactivate', 'Deactivate') }}"
                                                href="javascript:void(0)">
                                                <input type="checkbox" id="return_mode"
                                                    name="return_mode"
                ...
                {{-- <div class="mb-3">
                    ...
                    <input type="text" class="aurora-input" id="purchase_code"
