                            ...
                            <div class="tab-content mt-3" id="brandTabsContent">
                                ...
                                <div class="" id="content-en" role="tabpanel"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" class="aurora-input" placeholder="{{ labels('admin_labels.tax_placeholder', 'Tax') }}">
                                    </div>
                                </div>
                            ...
                            <div class="mb-3 col-12">
                                <label for=""
                                    class="form-label">{{ labels('admin_labels.percentage', 'Percentage') }}<span
                                        class="text-asterisks text-sm">*</span></label>
                                <input type="text" class="aurora-input" id="percentage" placeholder="20"
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_tax_table"><i
