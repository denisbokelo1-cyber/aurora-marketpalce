...
@section('content')
    ...
    <div class="aurora-modal-overlay" style="display:none" id="add_city" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                    ...
                    <div class="aurora-card-body">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="aurora-input" name="name" value="">
                            </div>
                        </div>
                            ...
                            @if ($lang->code !== 'en')
                                <div class="mb-3 col-md-12">
                                    <label for="translated_name_{{ $lang->code }}" class="form-label">
                                        {{ labels('admin_labels.name', 'Nom') }} ({{ $lang->language }})
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="aurora-input" oninput="validateNumberInput(this)"
                ...
                <form enctype="multipart/form-data" method="POST" class="submit_form">
                    ...
                    <div class="aurora-modal-footer">
                        <button type="button" class="aurora-btn aurora-btn-secondary" data-bs-dismiss="modal" aria-label="Fermer">
                            {{ !trans()->has('admin_labels.close') ? 'Fermer' : trans('admin_labels.close') }}
                        </button>
                    ...
                    <div class="row">
                        ...
                        <div class="ol-md-12 col-lg-12 col-xxl-6 d-flex justify-content-end ">
                            ...
                            <div
                                ...
                                <input type="text" data-table="admin_city_table" class="aurora-input" style="max-width:200px;display:inline-block"
