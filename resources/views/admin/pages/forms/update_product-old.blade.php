                        ...
                        <form action="{{ route('admin.products.update', $data->id) }}" enctype="multipart/form-data"
                            ...
                            <div class="ml-2 card2">
                                ...
                                <div class="float-end ml-2 mt-xxl-3 mt-7 next-button text-center" data-step="step3">
                                    <button type="button" class="btn btn-primary ">{{ labels('admin_labels.next_step', 'Suivant') }}</button>
                                </div>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 additional-info existing-additional-settings">
                                                    <div class="mt-4 col-md-12 additional-info-nav-header d-flex">
                                                        <div class="col-md-6">
                                                            <nav class="w-100">
                                                                <div class="aurora-tabs" id="product-tab"
                                                                    role="tablist">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 {{ isset($data->video_type) && ($data->video_type == 'youtube' || $data->video_type == 'vimeo') ? '' : 'd-none' }}"
                                                    ...
                                                    <label for="video"
                                                        ...
                                                        <span class="text-asterisks text-sm">*</span></label>
                                                    <input type="text" class="aurora-input" name="video"
                                                        id="video"
