...
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.categories_sliders', 'Categories Sliders')" :subtitle="labels(
        ...
        ['label' => labels('admin_labels.categories', 'Catégories'), 'url' => route('categories.index')],
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6 d-flex justify-content-end mt-md-0 mt-sm-2">
                                    ...
                                    <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_category_slider_table"><i
