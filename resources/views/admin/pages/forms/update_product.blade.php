    ...
    <section>
        <div class="">
            ...
            <form action="{{ route('admin.products.update', $data->id) }}" enctype="multipart/form-data" method="POST"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="aurora-input" placeholder="{{ labels('admin_labels.gucci_placeholder', 'Gucci') }}" id="pro_input_text"
                                            name="pro_input_name"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea class="aurora-input" id="short_description" placeholder="{{ labels('admin_labels.product_short_description_placeholder', 'Product Short Description') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="aurora-input" id="tags"
                ...
                <div class="aurora-card"><div class="aurora-card-body" style="padding:5 mt-4 {{ $data->type == 'digital_product' ? 'd-none' : '' }}">
                    <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number" class="aurora-input"
                                                                        ...
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number" min=0
                                                                                    class="aurora-input" name="height"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number" min=0
                                                                                    class="aurora-input" name="breadth"
                                                                        ...
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number" min=0
                                                                                    class="aurora-input" name="length"
