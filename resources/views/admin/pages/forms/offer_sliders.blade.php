...
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.offer_slider', 'Offer Slider')" :subtitle="labels(
        ...
        ['label' => labels('admin_labels.offers', 'Offres')],
                                                ...
                                                <div class="" id="content-en" role="tabpanel"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" placeholder="{{ labels('admin_labels.best_deals', 'Best Deals') }}" name="title"
                                                            class="aurora-input" value="{{ old('title') }}">
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6 d-flex justify-content-end ">
                                    ...
                                    <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_offer_slider_table"><i
