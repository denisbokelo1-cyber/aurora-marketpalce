            ...
            <form id="validationForm" method="POST" action="/admin/users/update/{{ auth()->user()->id }}"
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if ($isPublicDisk && !empty($user->image)) {
                            $imgPath = public_path(config('constants.USER_IMG_PATH') . '/' . $user->image);
                            $imagePath = file_exists($imgPath) ? asset(config('constants.USER_IMG_PATH') . '/' . $user->image) : asset(config('constants.NO_IMAGE'));
                        } else {
                            $imagePath = !empty($user->image) ? $user->image : asset(config('constants.NO_IMAGE'));
                        }
                        @endphp
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="aurora-input" type="text" name="username"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input class="aurora-input" readonly type="number" name="mobile"
                    ...
                    <!-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="aurora-input" readonly type="text" id="country_code" name="country_code"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="aurora-input" readonly type="email" name="email"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="address" class="aurora-input"
