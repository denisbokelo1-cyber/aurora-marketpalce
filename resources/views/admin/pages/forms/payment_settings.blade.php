...
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.payment_methods', 'Payment Methods')" :subtitle="labels(
        ...
        ['label' => labels('admin_labels.settings', 'Paramètres'), 'url' => route('settings.index')],
            ...
            <form class="form-horizontal submit_form" action="{{ route('payment_setting.store') }}" method="POST"
                ...
                <div class="aurora-card">
                    <div class="" id="v-pills-tabContent">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <select name="paypal_method"
                                        ...
                                        <option value="1"
                                            ...
                                            {{ labels('admin_labels.active_users', 'Actif') }}
                                        </option>
                                        <option value="0"
                                ...
                                <div class="aurora-card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="aurora-input" name="paypal_business_email"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="aurora-input" name="paypal_client_id"
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12 col-xl-6">
                                            ...
                                            <input type="text" class="aurora-input" readonly
                        ...
                        <div class="" id="phonepe" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-none">
                                        <label class="form-label"
                                            ...
                                            class="text-asterisks text-sm">*</span>
                                        <input type="text" class="aurora-input" name="phonepe_marchant_id"
                        ...
                        <div class="" id="razorpay" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <label class="form-label"
                                            ...
                                            class="text-asterisks text-sm">*</span>
                                        <input type="text" class="aurora-input" name="razorpay_key_id"
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label"
                                            ...
                                            class="text-asterisks text-sm">*</span>
                                        <input type="text" class="aurora-input" name="razorpay_secret_key"
                                            placeholder="Razorpay Key ID"
                        ...
                        <div class="" id="paystack" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0">
                            ...
                            <div class="aurora-card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="form-label"
                                            ...
                                            class="text-asterisks text-sm">*</span>
                                        <input type="text" class="aurora-input" name="paystack_key_id"
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label"
                                            ...
                                            class="text-asterisks text-sm">*</span>
                                        <input type="text" class="aurora-input" name="paystack_secret_key"
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12 col-xl-8">
                                        ...
                                        <input type="text" class="aurora-input" name="paystack_webhook_url"
                                            value="{{ url('admin/webhook/paystack_webhook') }}" disabled />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="" id="stripe" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0">
                            ...
                            <div class="aurora-card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select name="stripe_payment_mode" class="aurora-input">
                                            <option value="">
                                                {{ labels('admin_labels.select_mode', 'Select Mode') }}
                                            </option>
                                            <option value="test"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="aurora-input" name="stripe_webhook_url"
                        ...
                        @if ($hide_unwanted_payment_gateway == true)
                            <div class="" id="flutterwave" role="tabpanel"
                                ...
                                <div class="aurora-card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="flutterwave_public_key"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="flutterwave_secret_key"
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="flutterwave_encryption_key"
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="aurora-input" name="flutterwave_webhook_url"
                                                value="" disabled />
                                        </div>
                                    </div>
                            ...
                            <div class="" id="fatoorah" role="tabpanel"
                                aria-labelledby="v-pills-profile-tab">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        <h5 class="mb-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <textarea rows="5" name="myfatoorah_token" class="aurora-input"><?= isKeySetAndNotEmpty($settings, 'myfatoorah_token') ? $settings['myfatoorah_token'] : '' ?></textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                for="">{{ labels('admin_labels.payment_mode', 'Payment Mode') }}
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="myfatoorah__webhook_url"
                                                value="" readonly />
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="myfatoorah__successUrl"
                                                value="" readonly />
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="myfatoorah__errorUrl"
                                                value="" readonly />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="myfatoorah__secret_key"
                            ...
                            <div class="" id="midtrans" role="tabpanel"
                                aria-labelledby="v-pills-profile-tab">
                                <div>
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                ...
                                <div class="aurora-card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <select name="midtrans_payment_mode" class="aurora-input">
                                                <option value="">
                                                    {{ labels('admin_labels.select_mode', 'Select Mode') }}
                                                </option>
                                                <option value="sandbox"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="midtrans_client_key"
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="midtrans_merchant_id"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label"
                                                ...
                                                class="text-asterisks text-sm">*</span>
                                            <input type="text" class="aurora-input" name="midtrans_server_key"
                        ...
                        @endif
                        <div class="" id="direct_bank_transfer" role="tabpanel"
                            aria-labelledby="v-pills-profile-tab">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="form-label"
                                            ...
                                            class="text-asterisks text-sm">*</span>
                                        <input type="text" class="aurora-input" name="account_name"
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label"
                                            ...
                                            class="text-asterisks text-sm">*</span>
                                        <input type="number" step="any" class="aurora-input" name="account_number"
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <label class="form-label"
                                            ...
                                            class="text-asterisks text-sm">*</span>
                                        <input type="text" class="aurora-input" name="bank_name"
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label"
                                            ...
                                            class="text-asterisks text-sm">*</span>
                                        <input type="text" class="aurora-input" name="bank_code"
                        ...
                        <div class="" id="cash_on_delivery" role="tabpanel"
                            aria-labelledby="v-pills-profile-tab">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0">
