...
@section('title')
    {{ labels('admin_labels.custom_field', 'Champs personnalisés') }}
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.custom_fields', 'Champs personnalisés')" :subtitle="labels(
    ...
    )" :breadcrumbs="[['label' => labels('admin_labels.custom_fields', 'Champs personnalisés')]]" />
                    ...
                    <form method="POST" action="{{ route('admin.custom_fields.store') }}" class="submit_form">
                        ...
                        <div class="mb-3">
                            <label class="form-label">
                                {{ labels('admin_labels.field_name', 'Nom du champ') }}
                        ...
                        <div class="mb-3">
                            <label class="form-label">
                                {{ labels('admin_labels.field_type', 'Type du champ') }}
                                <span class='text-asterisks text-sm'>*</span>
                                <i class="fa fa-info-circle text-secondary ms-1"
                                   data-bs-toggle="popover"
                                   data-bs-placement="right"
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="requiredCheck">
                                {{ labels('admin_labels.required', 'Obligatoire') }}
                                <i class="fa fa-info-circle text-secondary ms-1"
                                   data-bs-toggle="popover"
                                   data-bs-placement="right"
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="activeCheck">
                                {{ labels('admin_labels.active', 'Actif') }}
                                <i class="fa fa-info-circle text-secondary ms-1"
                                   data-bs-toggle="popover"
                                   data-bs-placement="right"
                ...
                <div class="card content-area p-4 ">
                    <div class="aurora-flex-between aurora-mb-4">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4>{{ labels('admin_labels.custom_fields', 'Champs personnalisés') }}</h4>
                                </div>
                                ...
                                <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                    ...
                                    <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_custom_field_table"><i
                                        ...
                                        <table id='admin_custom_field_table' data-toggle="table"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="name" data-sortable="true">{{ labels('admin_labels.name', 'Nom') }}</th>
                                                    ...
                                                    <th data-field="required">{{ labels('admin_labels.required', 'Obligatoire') }}</th>
                                                    <th data-field="active">{{ labels('admin_labels.active', 'Actif') }}</th>
                                                    <th data-field="options">{{ labels('admin_labels.options', 'Options') }}</th>
                                                    <th data-field="operate">{{ labels('admin_labels.action', 'Actions') }}</th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
