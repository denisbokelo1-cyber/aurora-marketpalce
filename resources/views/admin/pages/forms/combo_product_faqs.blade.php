...
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xl-6 d-flex justify-content-end ">
                                    ...
                                    <a class="aurora-toolbar-btn" id="tableRefresh" data-table="combo_products_faqs_table"><i
    ...
    <div class="aurora-modal-overlay" style="display:none" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        aria-hidden="true">
    ...
    <div class="aurora-modal-overlay" style="display:none" id="add_combo_product_faq" tabindex="-1" role="dialog"
                        ...
                        <div class="mb-3 row">
                            <label for="question"
                                class="col-sm-5 form-label">{{ labels('admin_labels.question', 'Question') }}<span
                                    class='text-asterisks text-sm'>*</span></label>
                            <div class="col-sm-12">
                                <input type="text" class="aurora-input" id="question" placeholder="{{ labels('admin_labels.question_lower', 'question') }}"
                                    name="question">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="answer"
                                class="col-sm-5 form-label">{{ labels('admin_labels.answer', 'Answer') }}<span
                                    class='text-asterisks text-sm'>*</span></label>
                            <div class="col-sm-12">
                                <textarea class="aurora-input" id="answer" placeholder="{{ labels('admin_labels.answer_lower', 'answer') }}" name="answer"></textarea>
                            </div>
                        </div>
                        <div class="mb-3 d-flex float-end">
                            <button type="reset"
                                class="btn reset-btn me-2">{{ labels('admin_labels.reset', 'Réinitialiser') }}</button>
                            <button type="submit" class="btn btn-primary submit_button"
