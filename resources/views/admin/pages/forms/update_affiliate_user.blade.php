                            ...
                            <div class="aurora-card-body">
                                ...
                                <div class="step-page" id="page1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" value="{{ old('full_name', $user->username) }}"
                                                class="aurora-input" id="full_name" name="full_name"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" value="{{ old('email', $user->email) }}"
                                                class="aurora-input" id="email" name="email"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="aurora-input" id="mobile" name="mobile"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="address" class="form-label">{{ labels('admin_labels.address', 'Address') }} <span
                                                    class="text-danger">*</span></label>
                                            <textarea class="aurora-input" id="address" name="address" rows="3" placeholder="{{ labels('admin_labels.enter_address', 'Enter Address') }}">{{ old('address', $user->address) }}</textarea>
                                        </div>

                                    </div>
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="aurora-btn aurora-btn-primary" onclick="nextStep(2)">{{ labels('admin_labels.next', 'Suivant') }}</button>
                                    </div>
                                </div>
                                ...
                                <div class="step-page d-none" id="page2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="website_url" class="form-label">{{ labels('admin_labels.website', 'Website') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="url" class="aurora-input" id="website_url"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="application_url" class="form-label">{{ labels('admin_labels.mobile_app', 'Mobile App') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="url" class="aurora-input" id="application_url"
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="aurora-btn aurora-btn-secondary"
                                            onclick="prevStep(1)">{{ labels('admin_labels.previous_step', 'Précédent') }}</button>
                                        <button type="button" class="aurora-btn aurora-btn-primary"
                                            onclick="nextStep(3)">{{ labels('admin_labels.next_step', 'Suivant') }}</button>
                                    </div>
                                </div>
                                ...
                                <div class="step-page d-none" id="page3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="aurora-btn aurora-btn-secondary"
                                            onclick="prevStep(2)">{{ labels('admin_labels.previous', 'Précédent') }}</button>
