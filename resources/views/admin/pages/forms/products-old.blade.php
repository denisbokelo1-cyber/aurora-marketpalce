...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.add_product', 'Add Product') }}</h3>
            <p class="sub_title">
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('admin.home') }}">{{ labels('admin_labels.home', 'Accueil') }}</a>
                    </li>
    ...
    <section class="overview-statistic">
        <div class="col-xxl-12 p-0">
            <div class="row cols-5 d-flex">
                <div class="col-lg-12 col-md-12 col-xl-5 col-xxl-3 mb-md-4">
                ...
                <div class="col-md-12 col-xxl-9 mt-md-2 mt-sm-2 mt-xl-0">
                    <form action="{{ route('admin.products.store') }}" enctype="multipart/form-data" method="POST"
                        ...
                        <div class="card2 first-screen ml-2 show">
                            <div class="row">
                                <div class="col col-xxl-6">
                                    ...
                                    <div class="aurora-card"><div class="aurora-card-body" style="padding:5 mt-5">
                            ...
                            <div class="float-end ml-2 mt-xxl-3 mt-7 next-button text-center" data-step="step1">
                                <button type="button"
                                    class="aurora-btn aurora-btn-primary">{{ labels('admin_labels.next', 'Suivant') }}</button>
                            </div>
                        </div>
                        ...
                        <div class="card2 ml-2 ">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="pro_short_description"
                                                        ...
                                                        <span class='text-asterisks text-sm'>*</span></label>
                                                    <textarea class="aurora-input" id="short_description" placeholder="Product Short Description"
                            ...
                            <div class="float-end ml-2 mt-xxl-3 mt-7 next-button text-center" data-step="step2">
                                <button type="button"
                                    class="btn btn-primary ">{{ labels('admin_labels.next', 'Suivant') }}</button>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    ...
                                                    <select class="aurora-input" name="deliverable_type"
                                                        id="deliverable_type">
                                                        <option value="0">None</option>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-6 d-none" id="digital_link_container">
                                                                    <label for="video"
                                                                        ...
                                                                        <span
                                                                            class='text-asterisks text-sm'>*</span></label>
                                                                    <input type="url" class='aurora-input'
