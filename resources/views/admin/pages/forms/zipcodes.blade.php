...
@section('content')
    ...
    <div class="aurora-modal-overlay" style="display:none" id="add_zipcode" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="aurora-input" name="zipcode" id="zipcode" value="">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="aurora-input" name="minimum_free_delivery_order_amount"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="delivery_charges"
                                        ...
                                        <span class='text-asterisks text-xs'>*</span></label>
                                    <input type="number" class="aurora-input" name="delivery_charges" id="delivery_charges"
                                        min="0" value="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-xxl-6 d-flex justify-content-end ">
                            ...
                            <div class="input-group me-2 search-input-grp ">
                                ...
                                <input type="text" data-table="admin_zipcode_table" class="aurora-input" style="max-width:200px;display:inline-block"
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_zipcode_table"><i
