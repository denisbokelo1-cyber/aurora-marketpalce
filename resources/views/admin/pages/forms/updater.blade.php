    ...
    <div class="row">
        <div class="alert alert-primary alert-dismissible" role="alert">
            <?= labels('post_update_clear_browser_cache', 'Clear your browser cache by pressing CTRL+F5 after updating the system.') ?><button
                type="button" class="aurora-modal-close" data-bs-dismiss="alert" aria-label="Fermer"></button></div>
        <div class="alert alert-info alert-dismissible" role="alert">
            ...
            <button type="button" class="aurora-modal-close" data-bs-dismiss="alert" aria-label="Fermer"></button>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center"><span
                                class="aurora-badge aurora-badge-primary"><?= labels('admin_labels.current_version_label', 'Current version') . ' - ' ?>
