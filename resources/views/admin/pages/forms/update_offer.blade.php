                        ...
                        <div class="aurora-card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" id="offer_type" class="form-control type_event_trigger form-select"
                                    ...
                                    <option value="default" {{ $data->type == 'default' ? 'selected' : '' }}>{{ labels('admin_labels.default_theme', 'Par défaut') }}
                                    </option>
                            ...
                            <div id="type_add_html">
                                ...
                                <div
                                    ...
                                    <label for="category_id" class="mb-2">
                                        ...
                                        <span class='text-asterisks text-sm'>*</span></label>
                                    <select name="brand_id" class="aurora-input">
                            ...
                            <div class="form-group row offer_discount d-none mt-4" id="min_max_section">
                                ...
                                <div class="form-group col-md-6">
                                    <label
                                        ...
                                        <span class='text-asterisks text-sm'>*</span></label>
                                    <input type="number" class="aurora-input" name="max_discount" id="max_discount"
                                        min=1 max=100
