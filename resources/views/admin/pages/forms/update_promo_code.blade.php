                    ...
                    <div class="aurora-card-body">
                            ...
                            <div class="tab-content mt-3" id="UpdatebrandTabsContent">
                                ...
                                <div class="" id="content-en" role="tabpanel"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="aurora-input" placeholder="{{ labels('admin_labels.title_placeholder', 'Title') }}" name="title"
                                        ...
                                        <input type="text" class="aurora-input" name="message"
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="aurora-input" name="promo_code"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="aurora-input" name="start_date" id="start_date"
                                    value="{{ isset($data->start_date) ? $data->start_date : '' }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">{{ labels('admin_labels.end_date', 'End Date') }}
                                    <span class='text-asterisks text-sm'>*</span></label>
                                <input type="date" class="aurora-input" name="end_date" id="end_date"
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2"
                                    for="">{{ labels('admin_labels.number_of_users', 'No.Of Users') }}<span
                                        class='text-asterisks text-sm'>*</span></label>
                                <input type="number" min=1 class="aurora-input" name="no_of_users" min=1
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2"
                                    ...
                                    <span class='text-asterisks text-sm'>*</span></label>
                                <input type="number" class="aurora-input" name="max_discount_amount" min=1
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">{{ labels('admin_labels.status', 'Statut') }}
                                    <span class='text-asterisks text-sm'>*</span></label>
                                <select name="status" id="status" class="form-control form-select">
                                    ...
                                    <option value="1"
                                        {{ isset($data->status) && $data->status == '1' ? 'selected' : '' }}>{{ labels('admin_labels.active_users', 'Actif') }}
                                    </option>
                                    <option value="0"
