                            ...
                            <div class="card-body row">
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" class="aurora-input" name="username" id="username" value=" ">
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                                                    <label for="mobile"
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="number" maxlength="16" oninput="validateNumberInput(this)"
                                                            class="aurora-input" name="mobile" id="mobile" value=" ">
                                                    </div>
                                                </div> -->
                                    <div class="form-group">
                                        <label for="mobile"
                                    ...
                                    <div class="form-group">
                                        <label for="email" class="control-label">{{ labels('admin_labels.email', 'Email') }}
                                            <span class="text-asterisks text-sm">*</span></label>
                                        <div class="col-md-12">
                                            <input type="email" class="aurora-input" name="email" id="email" value=" ">
                                        </div>
                                    </div>
                                                ...
                                                <table class="table table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>{{ labels('admin_labels.view_permission', 'Voir') }}</th>
                                                            <th>{{ labels('admin_labels.create_permission', 'Create') }}</th>
                                                            <th>{{ labels('admin_labels.title_edit', 'Modifier') }}</th>
                                                            <th>{{ labels('admin_labels.title_delete', 'Supprimer') }}</th>
                                                        </tr>
                                                    </thead>
