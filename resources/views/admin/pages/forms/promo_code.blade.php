                    ...
                    <div class="aurora-card-body">
                            ...
                            <div class="tab-content mt-3" id="brandTabsContent">
                                <div class="" id="content-en" role="tabpanel"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="{{ labels('admin_labels.title_placeholder', 'Title') }}" name="title" class="aurora-input"
                                            value="{{ old('title') }}">
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="aurora-input" name="message" id="message"
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="aurora-input" name="promo_code" value="">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="aurora-input" name="start_date" id="start_date" value="">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                ...
                                <input type="date" class="aurora-input" name="end_date" id="end_date" value="">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" min=1 class="aurora-input" name="no_of_users" value="">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                ...
                                <input type="number" min=1 class="aurora-input" name="minimum_order_amount"
                                    value="">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2" for="">
                                ...
                                <select name="discount_type" class="form-control form-select discount_type">
                                    <option value="">{{ labels('admin_labels.select_option', 'Sélectionner') }}</option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" min=1 class="aurora-input" min=1 name="max_discount_amount"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="repeat_usage" id="repeat_usage" class="form-control form-select">
                                    <option value="">
                                        {{ labels('admin_labels.select', 'Sélectionner') }}
                                    </option>
                            ...
                            <div class="col-md-6 mb-3 d-none" id="repeat_usage_html">
                                ...
                                <input type="number" class="aurora-input" name="no_of_repeat_usage" min=1
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" id="status" class="form-control form-select">
                                    ...
                                    <option value="1">{{ labels('admin_labels.active_users', 'Actif') }}</option>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end ">
                                        ...
                                        <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_promocode_table"><i
