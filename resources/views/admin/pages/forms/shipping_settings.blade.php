                        ...
                        <div id="shiprocket_credentials_section"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="aurora-input" name="email" id="email"
                                ...
                                <div class="form-group">
                                    <label class="mb-3"
                                        for="password">{{ labels('admin_labels.password', 'Password') }}<span
                                            class="text-asterisks text-sm">*</span></label>
                                    <input type="password" class="aurora-input" name="password" id="password"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="aurora-input" name="webhook_url" id="webhook_url"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="aurora-input" name="webhook_token" id="webhook_token"
