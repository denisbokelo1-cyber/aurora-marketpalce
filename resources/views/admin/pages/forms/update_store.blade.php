                                        ...
                                        <div class="tab-content mt-3" id="UpdatebrandTabsContent">
                                            ...
                                            <div class="" id="content-en" role="tabpanel"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="aurora-input" placeholder="{{ labels('admin_labels.gucci_placeholder', 'Gucci') }}"
                                                        name="name"
                                            ...
                                            @foreach ($languages as $lang)
                                                @if ($lang->code !== 'en')
                                                    <div class="" id="content-{{ $lang->code }}"
                                        ...
                                        <div class="form-group col-md-12 mb-4">
                                            <select class="web_home_page_theme form-control form-select"
                                                ...
                                                <option value="web_home_page_theme_1"
                                                    ...
                                                    {{ labels('admin_labels.default_theme', 'Par défaut') }}
                                                </option>
                                ...
                                <div class="aurora-card"><div class="aurora-card-body" style="padding:5">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="tab-content mt-3" id="UpdatecategoriesTabsContent">
                                            ...
                                            @foreach ($languages as $lang)
                                                @if ($lang->code !== 'en')
                                                    <div class="" id="categorycontent-{{ $lang->code }}"
                                                        role="tabpanel" aria-labelledby="tab-{{ $lang->code }}">
                                                        <div class="mb-3">
                                                            <label
