                ...
                <div class="aurora-card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control form-select" name="type" id="type" required>
                            ...
                            <option value="upload">{{ labels('admin_labels.upload_option', 'Télécharger') }}</option>
                            <option value="update">{{ labels('admin_labels.update_option', 'Mettre à jour') }}</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <span class="aurora-input" id="upload_file_name"
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-3">
                        <button type="reset" class="aurora-btn aurora-btn-secondary">{{ labels('admin_labels.reset', 'Réinitialiser') }}</button>
                        <button type="submit" class="aurora-btn aurora-btn-primary">{{ labels('admin_labels.submit', 'Enregistrer') }}</button>
                    </div>
