                    ...
                    <form class="form-horizontal submit_form" action="{{ route('custom_message.store') }}" method="POST"
                        ...
                        <div class=" card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <textarea name="message" id="text-box" class="aurora-input" placeholder="{{ labels('admin_labels.place_some_text_here', 'Place some text here') }}"></textarea>
                                </div>
                            </div>
                            <div class="form-group row place_order d-none">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-6 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_custom_message_table"><i
