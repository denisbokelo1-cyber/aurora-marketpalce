    ...
    <div>
        <form action="{{ route('sellers.store') }}" enctype="multipart/form-data" class="submit_form" method="POST">
                            ...
                            <div class="aurora-card-body">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label for="firstName" class="form-label">{{ labels('admin_labels.name', 'Nom') }}
                                            <span class="text-asterisks text-sm">*</span>
                                        </label>
                                        <input class="aurora-input" type="text" placeholder="{{ labels('admin_labels.john_doe_placeholder', 'John Doe') }}" id="name"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <select class="aurora-input" id="country_code" name="country_code"
                                            ...
                                            <input type="text" class="aurora-input" id="phone" name="mobile"
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input class="aurora-input" placeholder="{{ labels('admin_labels.email_example_placeholder', 'johndoe@gmail.com') }}" type="email"
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" class="aurora-input" name="confirm_password"
                                    ...
                                    <div class="mb-3 col-md-6 form-password-toggle">
                                        ...
                                        <textarea name="address" class="aurora-input" placeholder="{{ labels('admin_labels.write_here_your_address', 'Write here your address') }}">{{ old('address') }}</textarea>
                        ...
                        <div class="aurora-card">
                            <div class="aurora-card-body">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="number" class="aurora-input" min=0 max=100 id="global_commission"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="alert alert-info mt-3 mb-3" role="alert">
                                        ...
                                        <ul class="mb-0 small text-dark">
                                            ...
                                            <li><strong>{{ labels('admin_labels.step_3', 'Step 3') }}:</strong> {{ labels('admin_labels.step_3_instruction', 'Click "Enregistrer" inside the popup to confirm your selection.') }}</li>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="aurora-input" id="account_number"
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="aurora-input" id="account_name"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="aurora-input" id="bank_name"
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="aurora-input" id="bank_code"
                            ...
                            <div class="aurora-card-body">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="text" name="store_name" class="aurora-input"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="text" name="store_url" class="aurora-input"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="basic-default-message" value="" name="description" class="aurora-input"
                                ...
                                <div class="row">
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <select class="aurora-input" name="deliverable_type" id="deliverable_type">
                                                <option value="1" selected>{{ labels('admin_labels.all_option', 'Tout') }}</option>
                                ...
                                <div class="form-group">
                                    <label for=""
                                        class="form-label">{{ labels('admin_labels.status', 'Statut') }}
                                    </label>
                                    <div class="mt-2">
                                        <div id="stsatus" class="btn-group d-flex justify-content-center"
                                            role="group" aria-label="Statut">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mt-2">
                                        <div id="stsatus" class="btn-group" role="group" aria-label="Statut">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="aurora-input" id="tax_name"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="aurora-input" id="tax_number"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="aurora-input" id="pan_number"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="aurora-input" id="latitude"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="aurora-input" id="longitude"
            ...
            <div class="d-flex justify-content-end mt-4">
                <button type="reset" class="btn mx-2 reset_button">{{ labels('admin_labels.reset', 'Réinitialiser') }}</button>
                <button type="submit"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="set_commission_offcanvas"
        ...
        <div class="offcanvas-header">
            <h5 id="set_commission_offcanvasLabel">
                ...
                type="button" class="aurora-modal-close" data-bs-dismiss="offcanvas" aria-label="Fermer"></button>
        </div>
        <form class="form-horizontal overflow-auto" id="add-seller-commission-form" action="" method="POST"
            enctype="multipart/form-data"> @csrf <div class="offcanvas-body"> <label for="Catégories"
                    class="col-sm-12 form-label">{{ labels('admin_labels.categories', 'Catégories') }}</label>
            ...
            <div class="offcanvas-footer d-flex justify-content-end"> <button type="reset"
                    class="btn mx-2 reset_button">{{ labels('admin_labels.reset', 'Réinitialiser') }}</button> <button
                    type="submit" class="btn btn-primary mx-2"
                    id="save_btn">{{ labels('admin_labels.save', 'Enregistrer') }}</button> </div>
        </form>
    </div>
@endsection
