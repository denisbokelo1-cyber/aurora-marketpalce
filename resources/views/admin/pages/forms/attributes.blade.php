                        ...
                        <div class="aurora-card-body">
                            ...
                            <div class="form-group col-sm-12 mb-4">
                                <label for="category_id"
                                    class="">{{ labels('admin_labels.categories', 'Catégories') }}
                            ...
                            <div class="form-group col-sm-12 mb-4">
                                ...
                                <div class="col-sm-12 attribute_name d-none">
                                    <input type="text" class="form-control " id="name" placeholder="{{ labels('admin_labels.name_placeholder', 'Nom') }}"
                                        name="name" value="">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_attribute_table"><i
