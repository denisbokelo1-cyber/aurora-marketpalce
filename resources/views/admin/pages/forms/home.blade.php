...
@section('title')
    {{ labels('admin_labels.dashboard', 'Tableau de bord') }}
@endsection
@php
...
@section('content')
    ...
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.dashboard', 'Tableau de bord') }}
            </h3>
            <p class="sub_title">
    ...
    <div class="col-md-12">
        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5 class="mb-3 home_page_statitics">
                                            {{ labels('admin_labels.sellers', 'Vendeurs') }}
                                        </h5>
                                    </div>
                        ...
                        <div class="aurora-card">
                            <div class="aurora-card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5 class="mb-3 home_page_statitics">
                                            {{ labels('admin_labels.orders', 'Commandes') }}
                                        </h5>
                                    </div>
                                    <div class="col-md-6 d-flex justify-content-end">
                        ...
                        <div class="aurora-card">
                            <div class="aurora-card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5 class="mb-3 home_page_statitics">
                                            {{ labels('admin_labels.products', 'Produits') }}
                                        </h5>
                                    </div>
                                    <div class="col-md-6 d-flex justify-content-end">
                                        ...
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            <div>
                                                <strong>{{ labels('admin_labels.order_id', 'Order ID') }}:
                                                    {{ $order->id }}</strong>
                                                <p class="mb-0">{{ labels('admin_labels.status', 'Statut') }}:
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ labels('admin_labels.action', 'Actions') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        @foreach($language['files'] as $file)
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <br>
                                                    <small class="aurora-text-muted">({{ $language['language_code'] }})</small>
                                                </td>
                                                <td>
                                                    <span class="aurora-badge aurora-badge-info">{{ strtoupper($file['file_type']) }}</span>
                                                </td>
                                                <td>
                                                    @if(count($file['missing_labels']) > 0)
                                                        <div class="missing-labels-preview">
                                                            ...
                                                            @if(count($file['missing_labels']) > 5)
                                                                <span class="aurora-text-muted">+{{ count($file['missing_labels']) - 5 }} more</span>
                                                            @endif
                                                        </div>
                                                        <a href="#"
                                                    ...
                                                    @else
                                                        <span class="aurora-text-muted">-</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <span class="aurora-badge aurora-badge-danger">{{ $file['missing_labels_count'] }}</span>
                                                </td>
                                                <td>
                                                    @if($file['updated_at'])
                                                        {{ \Carbon\Carbon::parse($file['updated_at'])->format('M d, Y H:i') }}
                                                    @else
                                                        <span class="aurora-text-muted">Never</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <a href="{{ route('language.index') }}?lang={{ $language['language_code'] }}&type={{ $file['file_type'] }}"
                                                       class="btn btn-sm btn-outline-primary">
                                                        <i class="fas fa-edit me-1"></i>{{ labels('admin_labels.edit', 'Modifier') }}
                                                    </a>
                                                </td>
                                            </tr>
                                            @endif
            ...
            <div class="aurora-modal-overlay" style="display:none" id="missingLabelsModal" tabindex="-1" aria-labelledby="missingLabelsModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="aurora-modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <span class="aurora-badge aurora-badge-info" id="modal_file_type"></span>
                            </div>
                            <div class="mb-3">
                                <strong>{{ labels('admin_labels.total_missing', 'Total Missing') }}:</strong>
                                <span class="aurora-badge aurora-badge-danger" id="modal_total_count"></span>
                            </div>
                            <hr>
                            <div class="mb-3">
                                <input type="text" id="search_missing_labels" class="aurora-input" placeholder="{{ labels('admin_labels.search_labels', 'Search labels...') }}">
                            </div>
                        ...
                        <div class="aurora-modal-footer">
                            <button type="button" class="aurora-btn aurora-btn-secondary" data-bs-dismiss="modal">{{ labels('admin_labels.close', 'Fermer') }}</button>
                            <button type="button" class="aurora-btn aurora-btn-primary" id="copy_all_labels_btn">
                                ...
                                <div class="aurora-card-body">
                                    ...
                                    <div class="chart-card-header d-flex justify-content-between mb-8">
                                        ...
                                        <ul class="nav nav-pills nav-pills-rounded chart-action float-right btn-group sale-tabs"
                                            role="group">
                                            <li class="nav-item"><a class="aurora-tab active" data-toggle="tab"
                                                    href="#Daily">{{ labels('admin_labels.today', 'Today') }}</a></li>
                                            <li class="nav-item"><a class="aurora-tab" data-toggle="tab"
                                ...
                                <div class="aurora-card-body">
                                    ...
                                    <div class="d-flex mt-5">
                                        <div class="progress-success-icon me-3 mx-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" class="order-overview-icon">
                                                <g id="Livrée" clip-path="url(#clip0_2198_6563)">
                                                    <path id="Vector"
                                        ...
                                        <div class="col">
                                            <div class="d-flex justify-content-between">
                                                <p class="m-0">{{ labels('admin_labels.delivered', 'Livrée') }}</p>
                                                <p class="total-order m-0 mt-1">
                                    ...
                                    <div class="d-flex mt-5">
                                        <div class="progress-danger-icon me-3 mx-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" class="order-overview-icon">
                                                <g id="Annulée" clip-path="url(#clip0_2198_6566)">
                                                    <g id="Icon">
                                                        <g id="Group">
                                                            <path id="Vector"
                                        ...
                                        <div class="col">
                                            <div class="d-flex justify-content-between">
                                                <p class="m-0">{{ labels('admin_labels.cancelled', 'Annulée') }}</p>
                                                <p class="total-order m-0 mt-1">
                                    ...
                                    <div class="d-flex mt-5">
                                        <div class="progress-pink-icon me-3 mx-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" class="order-overview-icon">
                                                <g id="Retournée" clip-path="url(#clip0_2198_6613)">
                                                    <g id="Icon">
                                        ...
                                        <div class="col">
                                            <div class="d-flex justify-content-between">
                                                <p class="m-0">{{ labels('admin_labels.returned', 'Retournée') }}</p>
                                                <p class="total-order m-0 mt-1">
    ...
    <div class="aurora-modal-overlay" style="display:none" id="edit_order_tracking_modal" tabindex="-1" role="dialog"
                ...
                <form class="form-horizontal " id="order_tracking_form"
                    ...
                    <div class="aurora-modal-body">
                        <div class="form-group ">
                            ...
                            <input type="text" class="aurora-input" name="courier_agency" id="courier_agency"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="aurora-input" name="tracking_id" id="tracking_id"
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="aurora-input" name="url" id="url"
                    ...
                    <div class="aurora-modal-footer">
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="aurora-btn aurora-btn-primary"
                                id="submit_btn">{{ labels('admin_labels.save', 'Enregistrer') }}</button>
                        </div>
                    </div>
                </form>
            </div>
