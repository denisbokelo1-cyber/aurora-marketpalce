...
<x-admin.breadcrumb :title="labels('admin_labels.add_product', 'Add Product')"
    ...
    :breadcrumbs="[
            ['label' => labels('admin_labels.products', 'Produits')],
...
<section class="overview-statistic">
    <div class="">
        <form action="{{ route('admin.combo_products.store') }}" class="submit_form" enctype="multipart/form-data"
                    ...
                    <div class="" id="content-en" role="tabpanel" aria-labelledby="tab-en">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="aurora-input" id="short_description"
                    ...
                    <div class="" id="content-{{ $lang->code }}" role="tabpanel"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="aurora-input" id="translated_short_description_{{ $lang->code }}"
            ...
            <div class="aurora-card"><div class="aurora-card-body" style="padding:5 mt-4 combo_product_quantity_and_others">
            ...
            <div class="aurora-card"><div class="aurora-card-body" style="padding:5 mt-4 combo_delivery_and_shipping_setting">
                    ...
                    <div class="col-md-6 ">
                        <div class="form-group">
                            ...
                            <select class="form-select form-select" name="deliverable_type" id="deliverable_type">
                                ...
                                <option value="1" class="combo_all_deliverable_type">{{ labels('admin_labels.all_option', 'Tout') }}</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="aurora-input" value="" min=1
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="aurora-input" value="" min=1 name="delivery_charges">
                        </div>
                    </div>
                    <div class="col-md-6 mt-7">
                        <div class="form-group">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex">
                                    <label for="" class="me-6 text-muted">{{ labels('admin_labels.enable_disable_bracket', '[Enable/Disable]') }}</label>
                                    <div class="aurora-toggle">
                                        <input type="checkbox" id="" name="cod_allowed">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="aurora-toggle">
                                        <input type="checkbox" id="" name="is_returnable">
                                    </div>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="simple_price" class="col-md-6 form-label">
                                                            {{ labels('admin_labels.price', 'Prix') }}:
                                                            <span class="text-asterisks text-sm">*</span>
                                                            <i class="fa fa-info-circle text-secondary ms-1"
                                                                data-bs-toggle="popover"
                                                                data-bs-placement="right"
                                            ...
                                            <div class="col col-xs-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select type="text" name="simple_product_stock_status"
                                                        ...
                                                        <option value="1">
                                                            {{ labels('admin_labels.in_stock_option', 'En stock') }}</option>
                                                        <option value="0">
