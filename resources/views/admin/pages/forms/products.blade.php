...
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.add_product', 'Add Product')" :subtitle="labels('admin_labels.add_products_with_power_and_simplicity', 'Add products with power and simplicity')" :breadcrumbs="[
        ['label' => labels('admin_labels.products', 'Produits'), 'url' => route('admin.products.index')],
    ...
    <div class="">
        <form class="" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" method="POST"
            id="save-product">
            @csrf
            <div class="aurora-card"><div class="aurora-card-body" style="padding:5">
            ...
            <div class="aurora-card"><div class="aurora-card-body" style="padding:5 mt-4">
                ...
                <div class="tab-content mt-3" id="brandTabsContent">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="aurora-input" id="pro_input_text"
                    ...
                    @foreach ($languages as $lang)
                        @if ($lang->code !== 'en')
                            <div class="" id="content-{{ $lang->code }}" role="tabpanel"
                ...
                <div class="row">
                    <div class="col-md-6 d-none indicator">
                        ...
                        <select class="aurora-input" name="indicator">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="aurora-input" id="tags" placeholder="{{ labels('admin_labels.tags_placeholder_example', 'dress,milk,almond') }}"
                                name="tags">
                        </div>
                    </div>
                </div>
            ...
            <div class="aurora-card"><div class="aurora-card-body" style="padding:5 mt-4 product_quantity_and_others">
                <div class="row">
            ...
            <div class="aurora-card"><div class="aurora-card-body" style="padding:5 mt-4 delivery_and_shipping_settings ">
                <div class="row">
                    <div class="col col-xxl-12">
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <select class="aurora-input" name="deliverable_type" id="deliverable_type">
                                        <option value="0">{{ labels('admin_labels.none_option', 'None') }}</option>
                                        <option value="1" class="all_deliverable_type">{{ labels('admin_labels.all_option', 'Tout') }}</option>
                            ...
                            @if (!$shiprocketEnabled)
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min=1 class="aurora-input" value=""
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div id="affiliate_info" style="display:none;">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="aurora-toggle">
                                                <input type="checkbox" id="is_in_affiliate"
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        <label class="me-6 text-muted form-label">[{{ labels('admin_labels.enable_disable', 'Enable/Disable') }}]</label>
                                        <div class="aurora-toggle">
                                            <input type="checkbox" id="is_cancelable_checkbox"
                                                name="is_cancelable">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-7 collapse" id='cancelable_till'>
                            <div class="form-group">
                                ...
                                <select class='aurora-input' name="cancelable_till">
                ...
                <div class="row">
                    <div class="col-md-12 additional-info existing-additional-settings">
                        <div class="mt-4 col-md-12 additional-info-nav-header d-flex">
                            <div class="col-md-6">
                                <nav class="w-100">
                                    <div class="aurora-tabs" id="product-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="tab-for-general-price"
                                            ...
                                            aria-selected="true">{{ labels('admin_labels.general', 'Général') }}</a>
                            ...
                            <div class="col-md-6">
                                <div class="align-items-center d-flex form-group justify-content-end">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="type" id="product-type" class="aurora-input"
                        ...
                        <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="simple_price"
                                                            class="col-md-6 form-label">{{ labels('admin_labels.price', 'Prix') }}:
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="aurora-input" name="weight"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="aurora-input" name="height"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="breadth"
                                                                    ...
                                                                    <small>(cms)</small> </label>
                                                                <input type="number" class="aurora-input" name="breadth"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label for="length"
                                                                    ...
                                                                    <small>(cms)</small> </label>
                                                                <input type="number" class="aurora-input" name="length"
                                            ...
                                            <div class="col col-xs-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select type="text"
                                                        ...
                                                        <option value="1">
                                                            {{ labels('admin_labels.in_stock', 'En stock') }}</option>
                                                        <option value="0">
                                                    ...
                                                    <div class="col col-xs-4 col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select type="text" id="stock_status_variant_type"
                                                                ...
                                                                <option value="1">{{ labels('admin_labels.in_stock', 'En stock') }}
                                                                </option>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-6 d-none" id="digital_link_container">
                                            <label for="video"
                                                ...
                                                <span class='text-asterisks text-sm'>*</span></label>
                                            <input type="url" class='aurora-input' name='download_link'
                            ...
                            <div class="" id="product-variants" role="tabpanel"
                ...
                <div class="aurora-card"><div class="aurora-card-body" style="padding:5">
                    ...
                    <div class="row mt-4">
                        <div class="form-group col-md-6">
                            ...
                            <select class="aurora-input" name="video_type" id="video_type">
                        ...
                        <div class="col-md-6 d-none" id="video_link_container">
                            ...
                            <input type="text" class="aurora-input" name="video" id="video"
    ...
    <div class="float-end ml-2 mt-xxl-3 mt-7 text-center">
        <button type="submit" id="submit_btn"
            class="btn btn-primary submit_button">{{ labels('admin_labels.submit', 'Enregistrer') }}</button>
    </div>
    </form>
    </div>
@endsection
