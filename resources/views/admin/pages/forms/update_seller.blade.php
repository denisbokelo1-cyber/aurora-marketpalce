...
@section('content')
    ...
    <div>
        <form class="form-horizontal form-submit-event submit_form"
                            ...
                            <div class="aurora-card-body">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="aurora-input" type="text" id="name" name="name"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="number" id="phone" name="mobile" min='1'
                                                maxlength="16" oninput="validateNumberInput(this)" class="aurora-input"
                                                placeholder=""
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input class="aurora-input" type="email" name="email"
                                    ...
                                    <div class="mb-3 col-md-6 form-password-toggle">
                                        ...
                                        <textarea name="address" class="aurora-input" placeholder="{{ labels('admin_labels.write_here_your_address', 'Write here your address') }}">{{ isset($seller_data->address) ? $seller_data->address : '' }}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="aurora-card">
                            <div class="aurora-card-body">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="number" class="aurora-input" max=100 min=0 id="global_commission"
                                ...
                                <div class="alert alert-info mt-3 mb-3" role="alert">
                                    ...
                                    <ul class="mb-0 small text-dark">
                                        ...
                                        <li><strong>Step 3:</strong> Click <strong>"Enregistrer"</strong> inside the popup to confirm your selection.</li>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select deliverable_type" name="deliverable_type"
                                                id="deliverable_type">
                                                <option value="1"
                                                    {{ $store_data[0]->deliverable_type == '1' ? 'selected' : '' }}>{{ labels('admin_labels.all_option', 'Tout') }}
                                                </option>
                                                <option value="2"
            ...
            <div class="d-flex justify-content-end mt-4">
                <button type="submit"
                    class="btn btn-primary submit_button">{{ labels('admin_labels.update', 'Mettre à jour') }}</button>
            </div>
        </form>
    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="set_commission_offcanvas"
        ...
        <div class="offcanvas-header">
            ...
            <button type="button" class="aurora-modal-close" data-bs-dismiss="offcanvas" aria-label="Fermer"></button>
        </div>
        <form class="form-horizontal overflow-auto" id="add-seller-commission-form" action="" method="POST"
            ...
            <div class="offcanvas-footer d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary mx-2"
                    id="save_btn">{{ labels('admin_labels.save', 'Enregistrer') }}</button>
            </div>
        </form>
    </div>
@endsection
