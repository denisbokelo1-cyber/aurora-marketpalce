...
@section('title')
    {{ labels('admin_labels.add_store', 'Ajouter une boutique') }}
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.add_store', 'Ajouter une boutique')" :subtitle="labels(
        'admin_labels.lets_unlesh_a_wave_of_new_stores_on_your_marketplace',
        'Let’s unleash a wave of new stores on your marketplace.',
    )" :breadcrumbs="[
        ['label' => labels('admin_labels.stores', 'Boutiques')],
        ['label' => labels('admin_labels.add_store', 'Ajouter une boutique')],
    ]" />
    @php
    ...
    @endphp
    <div style="max-width:1600px;margin:0 auto"><div class="row">
                <form id="" action="{{ route('admin.stores.store') }}" class="submit_form"
                    enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="aurora-card aurora-mb-6">
                        <div class="row">
                            <div class="">
                                <div class="aurora-card"><div class="aurora-card-body" style="padding:5">
                                        ...
                                        <div class="" id="content-en" role="tabpanel"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" placeholder="{{ labels('admin_labels.grocery_placeholder', 'Grocery') }}" name="name"
                                                    class="aurora-input" value="{{ old('name') }}">
                                            </div>
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="aurora-input" name="description"
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="aurora-toggle">
                                                    <input type="checkbox" id="is_default_store"
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12 col-lg-12">
                                            ...
                                            <textarea name="note_for_necessary_documents" class="aurora-input"
                                ...
                                <div class="aurora-card"><div class="aurora-card-body" style="padding:5">
                                    ...
                                    <div class="form-group col-md-12 mb-4">
                                        <select class="web_home_page_theme form-control form-select"
                                            ...
                                            <option value="web_home_page_theme_1">{{ labels('admin_labels.default_theme', 'Par défaut') }}</option>
                            ...
                            <div class="">
                                <div class="aurora-card"><div class="aurora-card-body" style="padding:5">
                                    ...
                                    <div class="col-md-12 mb-4 mt-4">
                                        <div class="row mt-4">
                                            <ul class="aurora-tabs" id="categoriesTabs" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="language-nav-link nav-link active" id="tab-en"
                                            ...
                                            <div class="tab-content mt-3" id="UpdatecategoriesTabsContent">
                                                ...
                                                <div class="" id="categorycontent-en"
