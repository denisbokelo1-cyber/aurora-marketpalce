...
@section('content')
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <div class="d-flex mt-3 align-items-center">
                                <span class="body-default me-1">{{ labels('admin_labels.name', 'Nom') }}:</span>
                                        ...
                                        <table
                                            ...
                                            <thead class="thead-light thead-50 text-capitalize">
                                                <tr>
                                                    ...
                                                    <th>{{ labels('admin_labels.price', 'Prix') }}</th>
                    ...
                    <div class="d-flex mt-2 align-items-center">
                        ...
                        @if (isset($transaction_search_res) && !empty($transaction_search_res))
                            <a href="javascript:void(0)" class="edit_transaction btn active ms-5"
                                ...
                                <i class='bx bxs-pencil me-1'></i>{{ labels('admin_labels.edit', 'Modifier') }}
                            </a>
                        @endif
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($bank_transfer as $row1)
                                                ...
                                                <div
                                                    ...
                                                    @if ($row1->status == 0)
                                                        <label for=""
                                                            class="badge bg-warning ms-1">{{ labels('admin_labels.pending_status', 'En attente') }}</label>
                                                    ...
                                                    <button class="btn btn-primary btn-xs ms-1 mb-1 delete-data"
                                                        title="{{ labels('admin_labels.title_delete', 'Supprimer') }}"
    ...
    <div class="aurora-modal-overlay" style="display:none" tabindex="-1" role="dialog" aria-hidden="true" id="payment_transaction_modal">
