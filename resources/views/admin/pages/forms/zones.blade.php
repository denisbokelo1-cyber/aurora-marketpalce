                    ...
                    <div class="aurora-card-body">
                        ...
                        <div class="tab-content mt-3" id="brandTabsContent">
                            <div class="" id="content-en" role="tabpanel" aria-labelledby="tab-en">
                                <div class="mb-3">
                                    <label for="title" class="form-label">{{ labels('admin_labels.name', 'Nom') }}<span
                                            class="text-asterisks text-sm">*</span></label>
                                    <input type="text" placeholder="" name="name" class="aurora-input"
                                        value="{{ old('name') }}">
                                </div>
                            </div>
                            ...
                            <div data-repeater-list="zipcode_group">
                                <div data-repeater-item>
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 mt-2">
                                            <input type="text" name="zipcode_delivery_charge" class="aurora-input"
                                        ...
                                        <div class="col-md-2">
                                            <input data-repeater-delete type="button" class="btn btn-secondary mt-2"
                                                value="{{ labels('admin_labels.delete', 'Supprimer') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div data-repeater-list="city_group">
                                <div data-repeater-item>
                                    <div class="row city_list_parent">
                                        ...
                                        <div class="col-md-5 mt-2">
                                            <input type="text" name="city_delivery_charge" class="aurora-input"
                                                placeholder="{{ labels('admin_labels.delivery_charge', 'Delivery Charge') }}" value="" />
                                        </div>
                                        <div class="col-md-2">
                                            <input data-repeater-delete type="button" class="btn btn-secondary mt-2"
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                    ...
                                    <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_zone_table"><i
