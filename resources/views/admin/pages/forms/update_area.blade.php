                            ...
                            <div class="form-group">
                                <form action="{{ url('/admin/area/update/' . $data->id) }}" enctype="multipart/form-data"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="aurora-input" name="area_name"
                                    ...
                                    <div class="mb-3 d-flex justify-content-start">
                                        <button type="submit" class="btn btn-sm btn-primary" id="">{{ labels('admin_labels.update_option', 'Mettre à jour') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
