                ...
                <div class="aurora-card">
                    <div class="aurora-card-body">
                        <form id="" action="{{ route('contact_us.store') }}" class="submit_form"
                            ...
                            <textarea class="aurora-input" name="contact_us" placeholder="Contact Us" rows="5">{{ isset($contact_us['contact_us']) ? $contact_us['contact_us'] : '' }}</textarea>
                ...
                <div class="aurora-card">
                    <div class="aurora-card-body">
                        <form id="" action="{{ route('about_us.store') }}" class="submit_form"
                            ...
                            <textarea class="aurora-input" name="about_us" placeholder="About Us" rows="5">{{ isset($about_us['about_us']) ? $about_us['about_us'] : '' }}</textarea>
                            <div class="d-flex justify-content-end mt-4">
                                <button type="reset" class="btn mx-2 reset_button"
                                    id="">{{ labels('admin_labels.reset', 'Réinitialiser') }}</button>
                                <button type="submit"
