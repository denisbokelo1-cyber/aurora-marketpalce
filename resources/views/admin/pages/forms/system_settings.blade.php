...
@section('content')
    ...
    <x-admin.breadcrumb :title="labels('admin_labels.system_settings', 'System Settings')" :subtitle="labels(
        ...
        ['label' => labels('admin_labels.home', 'Accueil'), 'url' => route('admin.home')],
            ...
            <form id="" action="{{ route('system_settings.store') }}" class="submit_form"
                ...
                <div class="aurora-card">
                    <div class="" id="v-pills-tabContent">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="number" maxlength="16" oninput="validateNumberInput(this)"
                                                class="aurora-input" id="support_number" name="support_number"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="email" class="aurora-input" id="support_email"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="aurora-input" id="android_customer"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="aurora-input" id="ios_customer"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="aurora-input" id="android_seller"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="aurora-input" id="ios_seller"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="aurora-input" id="android_delivery"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="aurora-input" id="ios_delivery"
                                ...
                                <div class="aurora-card-body">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="aurora-input" id="deep_link_scheme"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="aurora-input" id="deep_link_host"
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" class="aurora-input" id="android_package_name"
                        ...
                        <div class="" id="logo_and_storage_setting" role="tabpanel"
                                                            ...
                                                            <div
                                                                ...
                                                                <a href="javascript:void(0)" class="delete-onboard-media"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        {{ labels('admin_labels.title_delete', 'Supprimer') }}</span></a>
                                                    ...
                                                    @foreach ($settings['on_boarding_video'] as $row)
                                                        <div
                                                            ...
                                                            <a href="javascript:void(0)" class="delete-onboard-media"
                                                                ...
                                                                <span
                                                                    class="btn btn-block bg-gradient-danger text-danger btn-xs"><i
                                                                        class="far fa-trash-alt "></i> {{ labels('admin_labels.title_delete', 'Supprimer') }}</span></a>
                        ...
                        <div class="" id="system_setting" role="tabpanel"
                            aria-labelledby="v-pills-profile-tab">
                            <div class="aurora-card">
                                <div class="aurora-card-header">
                                ...
                                <div class="aurora-card-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="number" class="aurora-input" id="basic-default-fullname"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label"
                                                for="basic-default-fullname">{{ labels('admin_labels.maximum_item_allowed_in_cart', 'Maximum Items Allowed In Cart') }}<span
                                                    class='text-asterisks text-sm'>*</span></label>
                                            <input type="number" min=1 class="aurora-input" id="basic-default-fullname"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label"
                                                for="basic-default-fullname">{{ labels('admin_labels.max_days_to_return_item', 'Max days to return item') }}<span
                                                    class='text-asterisks text-sm'>*</span></label>
                                            <input type="number" class="aurora-input" id="basic-default-fullname" min=1
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="aurora-input" id="google_map_key"
                        ...
                        <div class="" id="delivery_charge_setting" role="tabpanel"
                            aria-labelledby="v-pills-profile-tab">
                            <div class="aurora-card">
                                <div class="aurora-card-header">
                        ...
                        <div class="" id="app_and_system_setting" role="tabpanel"
                            aria-labelledby="v-pills-profile-tab">
                            <div class="aurora-card">
                                <div class="aurora-card-header">
                        ...
                        <div class="" id="refer_and_earn_setting" role="tabpanel"
                            aria-labelledby="v-pills-profile-tab">
                            <div class="aurora-card">
                                <div class="aurora-card-header">
                        ...
                        <div class="" id="welcome_wallet_balance" role="tabpanel"
                            aria-labelledby="v-pills-profile-tab">
                            <div class="aurora-card">
                                <div class="aurora-card-header">
                        ...
                        <div class="" id="maintenance_mode" role="tabpanel"
                            aria-labelledby="v-pills-profile-tab">
                            <div class="aurora-card">
                                <div class="aurora-card-header">
                                ...
                                <div class="aurora-card-body">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <textarea type="text" class="aurora-input" id="basic-default-fullname" placeholder=""
                        ...
                        <div class="" id="authentication_setting" role="tabpanel"
                            aria-labelledby="v-pills-profile-tab">
                            <div class="aurora-card">
                                <div class="aurora-card-header">
                        ...
                        <div class="" id="cron_job" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <div class="aurora-card">
                                <div class="aurora-card-header">
                                ...
                                <div class="aurora-card-body">
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" disabled class="aurora-input"
                        ...
                        <div class="aurora-modal-overlay" style="display:none" id="howItWorksModal1" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="aurora-modal-header">
                                        ...
                                        <button type="button" class="aurora-modal-close" data-bs-dismiss="modal"
                        ...
                        <div class="aurora-modal-overlay" style="display:none" id="howItWorksModal" tabindex="-1" role="dialog"
