                        ...
                        <div class="card shadow-sm">
                            <div class="aurora-card-body">
                                ...
                                <div class="step-page" id="page1">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="aurora-input" id="full_name" name="full_name" placeholder="{{ labels('admin_labels.enter_full_name', 'Enter Full Name') }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="email" class="form-label">{{ labels('admin_labels.email_address', 'Email Address') }} <span class="text-danger">*</span></label>
                                            <input type="email" class="aurora-input" id="email" name="email" placeholder="{{ labels('admin_labels.enter_email', 'Enter Email') }}">
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="aurora-input" id="mobile" name="mobile" maxlength="16" placeholder="{{ labels('admin_labels.enter_mobile', 'Enter Mobile') }}" oninput="validateNumberInput(this)">
                                              </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="password" class="form-label">{{ labels('admin_labels.password', 'Password') }} <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <input type="password" class="aurora-input" id="password" name="password" placeholder="{{ labels('admin_labels.enter_password', 'Enter Password') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="aurora-input" id="password_confirmation" name="password_confirmation" placeholder="{{ labels('admin_labels.enter_confirm_password', 'Enter Confirm Password') }}">
                                                <button type="button" class="btn btn-outline-secondary toggleAffiliatePassword"><i class="fa fa-eye"></i></button>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="address" class="form-label">{{ labels('admin_labels.address', 'Address') }} <span class="text-danger">*</span></label>
                                            <textarea class="aurora-input" id="address" name="address" rows="3" placeholder="{{ labels('admin_labels.enter_address', 'Enter Address') }}"></textarea>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end mt-3">
                                        <button type="button" class="aurora-btn aurora-btn-primary" onclick="nextStep(2)">{{ labels('admin_labels.next_step', 'Suivant') }}</button>
                                    </div>
                                </div>
                                ...
                                <div class="step-page d-none" id="page2">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="url" class="aurora-input" id="website_url" name="website_url" placeholder="{{ labels('admin_labels.website_url_example', 'https://www.example.com/myblog') }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="application_url" class="form-label">{{ labels('admin_labels.mobile_app', 'Mobile App') }} <span class="text-danger">*</span></label>
                                            <input type="url" class="aurora-input" id="application_url" name="application_url" placeholder="{{ labels('admin_labels.application_url_example', 'https://xxxx/dp/xxxx') }}">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between mt-3">
                                        <button type="button" class="aurora-btn aurora-btn-secondary" onclick="prevStep(1)">{{ labels('admin_labels.previous', 'Précédent') }}</button>
                                        <button type="button" class="aurora-btn aurora-btn-primary" onclick="nextStep(3)">{{ labels('admin_labels.next', 'Suivant') }}</button>
                                    </div>
                                </div>
                                ...
                                <div class="step-page d-none" id="page3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">{{ labels('admin_labels.status', 'Statut') }} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="aurora-btn aurora-btn-secondary" onclick="prevStep(2)">{{ labels('admin_labels.previous', 'Précédent') }}</button>
