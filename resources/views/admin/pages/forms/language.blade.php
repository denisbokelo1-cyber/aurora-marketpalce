                    ...
                    <form class="submit_form" action="{{ route('language.store') }}" method="POST"
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <label
                                    class="form-label mb-0">{{ labels('admin_labels.language_action', 'Actions') }}</label>
                        ...
                        <div id="create_language_fields" class="language-fields-section">
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="aurora-input" id="language" name="language"
                                        placeholder="{{ labels('admin_labels.english_placeholder', 'English') }}" value="{{ old('language') }}">
                                    <small
                                        class="aurora-text-muted">{{ labels('admin_labels.example_english_hindi', 'Example: English, Hindi') }}</small>
                                </div>
                                <div class="col-md-3">
                                    <div class="d-flex align-items-center gap-2">
                                    ...
                                    <input type="text" class="aurora-input" id="code" name="code"
                                        placeholder="{{ labels('admin_labels.en_placeholder', 'en') }}" value="{{ old('code') }}">
                                    <small
                                        class="aurora-text-muted">{{ labels('admin_labels.use_iso_code', 'Use ISO code') }}</small>
                                </div>
                                <div class="col-md-3">
                                    <div class="d-flex align-items-center gap-2">
                                    ...
                                    <input type="text" class="aurora-input" id="native_language" name="native_language"
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                @foreach ($labelFiles as $type => $label)
                                    <div class="col-12">
                                        ...
                                        <small class="aurora-text-muted">{{ labels('admin_labels.json_or_php_file_for', 'JSON or PHP file for') }} {{ strtolower($label) }}.</small>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div id="select_language_fields" class="language-fields-section d-none">
                            <div class="row g-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <select name="language_code" id="language_code" class="aurora-input">
                        ...
                        <div class="mt-3 d-flex flex-wrap gap-2">
                            ...
                            <button type="submit" class="btn btn-primary submit_button">
                                <i class="fas fa-save me-2"></i>{{ labels('admin_labels.save', 'Enregistrer') }}
                            </button>
                        </div>
                    </form>
                ...
                <div class="aurora-card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="download_language_code" id="download_language_code" class="aurora-input">
                                <option value="">{{ labels('admin_labels.select', 'Sélectionner') }}</option>
                                @foreach ($languages as $language)
                                    <option value="{{ $language->code }}"
                                        {{ $language->code == $language_code ? 'selected' : '' }}>
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <button type="button" id="download_file_btn" class="aurora-btn aurora-btn-primary"
