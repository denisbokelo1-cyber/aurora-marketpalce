                    ...
                    <form id="" action="{{ route('time_slot.store') }}" class="submit_form"
                        ...
                        <div class="aurora-card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="aurora-input" name="title"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="aurora-input" name="from_time"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="aurora-input" name="to_time"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="aurora-input" name="last_order_time"
                            ...
                            <div class="mb-3">
                                ...
                                <label for="" class="form-label">{{ labels('admin_labels.status', 'Statut') }}<span
                                        class="text-asterisks text-sm">*</span></label>
                                ...
                                <select name="status" class="form-control form-select">
                                    ...
                                    <option value="1"
                                        ...
                                        {{ labels('admin_labels.active_users', 'Actif') }}</option>
                                    <option value="0"
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                                ...
                                <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_time_slot_table"><i
