...
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.settings', 'Paramètres')" :subtitle="labels(
                ...
                <div class="aurora-card-body">
                    ...
                    <form class="form-horizontal submit_form" action="{{ route('admin.affiliate.settings.store') }}"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" maxlength="16" min=1 class="aurora-input"
                                ...
                                @if (!empty($affiliateCommissions))
                                    @foreach ($affiliateCommissions as $item)
                                        <div class="row repeater-item mb-3">
                                            ...
                                            <div class="col-md-5 p-1">
                                                <input type="number" min=1 max=100 class="aurora-input" name="commission[]"
