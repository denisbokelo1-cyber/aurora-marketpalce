                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="aurora-modal-overlay" style="display:none" id="openrouter_detail_modal" tabindex="-1"
                                        ...
                                        <input type="text" name="openrouter_api_key" class="aurora-input"
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="aurora-modal-overlay" style="display:none" id="gemini_detail_modal" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="aurora-modal-body">
                                        ...
                                        <input type="text" name="gemini_api_key" class="aurora-input"
