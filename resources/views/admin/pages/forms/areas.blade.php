                    ...
                    <form class="form-horizontal form-submit-event submit_form" action="{{ route('admin.area.store') }}"
                        ...
                        <div class="aurora-card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="aurora-input" name="area_name" id="area_name"
                                            value="">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="delivery_charges" class="control-label">Delivery Charges <span
                                                class='text-danger text-xs'>*</span></label>
                                        <input type="number" class="aurora-input" name="delivery_charges"
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="aurora-btn aurora-btn-primary">{{ labels('admin_labels.add_area', 'Add Area') }}</button>
                            </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="name" data-disabled="1" data-sortable="false">
                                        {{ labels('admin_labels.name', 'Nom') }}</th>
