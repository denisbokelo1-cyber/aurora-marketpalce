                            ...
                            <form id="" action="{{ route('blogs.store') }}" class="submit_form"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        {{-- <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="aurora-input" id="title"
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <textarea name="short_description" class="aurora-input" rows="3"
                                        ...
                                        <small
                                            class="aurora-text-muted">{{ labels('admin_labels.short_description_hint', 'This will be shown in blog listing cards') }}</small>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <label for=""
                                        ...
                                        <small
                                            class="aurora-text-muted">{{ labels('admin_labels.description_hint', 'Full HTML content for blog details page') }}</small>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                    ...
                                    <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_blog_table"><i
