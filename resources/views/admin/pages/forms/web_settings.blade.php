            ...
            <div class="col-md-2">
                <div class="card sticky-top">
                    <ul class="nav flex-column nav-pills menu payment-sidebar">
                        <li class="nav-item">
                            <a class="aurora-tab active" data-bs-toggle="tab" role="tab"
                                href="#general_setting">{{ labels('admin_labels.general_settings', 'General Settings') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="aurora-tab" data-bs-toggle="tab"
                                        ...
                                        <div class="row">
                                            <div class="aurora-card-body">
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" class="aurora-input" name="site_title"
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label
                                                            ...
                                                            <span class='text-danger text-xs'>*</span></label>
                                                        <input type="text" class="aurora-input" name="support_number"
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label
                                                            ...
                                                            <span class='text-danger text-xs'>*</span></label>
                                                        <input type="text" class="aurora-input" name="support_email"
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label
                                                            ...
                                                            <span class='text-danger text-xs'>*</span></label>
                                                        <textarea name="copyright_details" id="copyright_details" class="aurora-input" cols="30" rows="3"><?= isset($web_settings['copyright_details']) ? outputEscaping($web_settings['copyright_details']) : '' ?></textarea>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label
                                                            for="address">{{ labels('admin_labels.address', 'Address') }}
                                                            <span class='text-danger text-xs'>*</span></label>
                                                        <textarea name="address" id="address" class="aurora-input" cols="30" rows="5"><?= isset($web_settings['address']) ? outputEscaping($web_settings['address']) : '' ?></textarea>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label
                                                        ...
                                                        <textarea name="app_short_description" id="app_short_description" class="aurora-input" cols="30" rows="5"><?= isset($web_settings['app_short_description']) ? outputEscaping($web_settings['app_short_description']) : '' ?></textarea>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label
                                                            for="map_iframe">{{ labels('admin_labels.map_iframe', 'Map Iframe') }}
                                                            <span class='text-danger text-xs'>*</span></label>
                                                        <textarea name="map_iframe" id="map_iframe" class="aurora-input" cols="30" rows="5"><?= isset($web_settings['map_iframe']) ? outputEscaping($web_settings['map_iframe']) : '' ?></textarea>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label
                                                            ...
                                                            <span class='text-danger text-xs'>*</span></label>
                                                        <textarea name="meta_keywords" id="meta_keywords" class="aurora-input" cols="30" rows="5"><?= isset($web_settings['meta_keywords']) ? str_replace(["\n\r", "\n", "\r", '\\'], '', $web_settings['meta_keywords']) : '' ?></textarea>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label
                                                            for="support_email">{{ labels('admin_labels.meta_description', 'Meta Description') }}
                                                            <span class='text-danger text-xs'>*</span></label>
                                                        <textarea name="meta_description" id="meta_description" class="aurora-input" cols="30" rows="5"><?= isset($web_settings['meta_description']) ? $web_settings['meta_description'] : '' ?></textarea>
                                                    </div>
                                                </div>
                                                <hr>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        <label
                                                            ...
                                                            <span class='text-asterisks text-xs'>*</span></label>
                                                        <input type="text" class="aurora-input"
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea name="app_download_section_short_description" id="app_download_section_short_description"
                                                            class="aurora-input" cols="30" rows="5"><?= isset($web_settings['app_download_section_short_description']) ? outputEscaping($web_settings['app_download_section_short_description']) : '' ?></textarea>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="aurora-input" name="twitter_link"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="aurora-input" name="facebook_link"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="aurora-input" name="instagram_link"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="aurora-input" name="youtube_link"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <input type="text" class="aurora-input" name="shipping_title"
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <textarea name="shipping_description" class="aurora-input" id="shipping_description" cols="30" rows="4"
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <input type="text" class="aurora-input" name="return_title"
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <textarea name="return_description" class="aurora-input" id="return_description" cols="30" rows="4"
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <input type="text" class="aurora-input" name="support_title"
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        <label
                                                            for="shipping_description">{{ labels('admin_labels.description', 'Description') }}</label>
                                                        <textarea name="support_description" class="aurora-input" id="support_description" cols="30" rows="4"
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        ...
                                                        <textarea name="safety_security_description" class="aurora-input" id="safety_security_description" cols="30"
                                            ...
                                            <div class="form-group">
                                                <button type="reset" class="btn reset-btn"
                                                    id="">{{ labels('admin_labels.reset', 'Réinitialiser') }}</button>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="apiKey">{{ labels('admin_labels.api_key', 'APIkey') }} <span
                                                        class='text-danger text-xs'>*</span></label>
                                                <input type="text" class="aurora-input" name="apiKey"
                                            ...
                                            <div class="form-group col-md-6">
                                                <label
                                                    ...
                                                    <span class='text-danger text-xs'>*</span></label>
                                                <input type="text" class="aurora-input" name="authDomain"
                                            ...
                                            <div class="form-group col-md-6">
                                                <label
                                                    ...
                                                    <span class='text-danger text-xs'>*</span></label>
                                                <input type="text" class="aurora-input" name="databaseURL"
                                            ...
                                            <div class="form-group col-md-6">
                                                <label
                                                    ...
                                                    <span class='text-danger text-xs'>*</span></label>
                                                <input type="text" class="aurora-input" name="projectId"
                                            ...
                                            <div class="form-group col-md-6">
                                                <label
                                                    ...
                                                    <span class='text-danger text-xs'>*</span></label>
                                                <input type="text" class="aurora-input" name="storageBucket"
                                            ...
                                            <div class="form-group col-md-6">
                                                <label
                                                    ...
                                                    <span class='text-danger text-xs'>*</span></label>
                                                <input type="text" class="aurora-input" name="messagingSenderId"
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="appId">{{ labels('admin_labels.app_id', 'APP ID') }} <span
                                                        class='text-danger text-xs'>*</span></label>
                                                <input type="text" class="aurora-input" name="appId"
                                            ...
                                            <div class="form-group col-md-6">
                                                <label
                                                    ...
                                                    <span class='text-danger text-xs'>*</span></label>
                                                <input type="text" class="aurora-input" name="measurementId"
