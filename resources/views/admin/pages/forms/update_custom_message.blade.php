            ...
            <form class="form-horizontal submit_form" action="{{ url('/admin/custom_message/update/' . $data->id) }}"
                ...
                <div class="aurora-card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <textarea name="message" id="text-box" class="aurora-input" placeholder="{{ labels('admin_labels.place_some_text_here', 'Place some text here') }}">{{ isset($data->message) ? $data->message : '' }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row place_order d-none">
