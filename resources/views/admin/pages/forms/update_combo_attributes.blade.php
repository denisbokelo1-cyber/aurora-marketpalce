                    ...
                    <form action="{{ url('/admin/combo_product_attributes/update/' . $attribute_data->id) }}"
                        ...
                        <div class="mb-3">
                            <label class="form-label"
                                for="basic-default-fullname">{{ labels('admin_labels.name', 'Nom') }}
                            ...
                            <input type="text" class="aurora-input" id="basic-default-fullname" placeholder="pizza"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="aurora-input" readonly id="attribute_values"
