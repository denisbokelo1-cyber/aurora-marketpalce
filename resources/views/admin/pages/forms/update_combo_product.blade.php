    ...
    <section class="overview-statistic">
        <div>
            <form action="{{ route('admin.combo_products.update', $data->id) }}" class="submit_form"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="aurora-input" name="seller_id" id="seller_id" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="aurora-input" name="product_type_in_combo" id="product_type" disabled>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="aurora-input" id="pro_input_text" placeholder="{{ labels('admin_labels.gucci_placeholder', 'Gucci') }}"
                                            name="title"
                        ...
                        <div class="col-md-6 mt-7">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="aurora-toggle">
                                        <input type="checkbox" id="" name="is_prices_inclusive_tax"
                                ...
                                <select class="form-control form-select" name="deliverable_type" id="deliverable_type">
                                    ...
                                    @if ($deliverable_type->deliverable_type == '2' || $deliverable_type->deliverable_type == '3')
                                        <option value="1" class="combo_all_deliverable_type d-none" {{ $data->deliverable_type == '1' ? 'selected' : '' }}>
                                            {{ labels('admin_labels.all_option', 'Tout') }}
                                        </option>
                                    @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="aurora-input" min=0
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        <label for="" class="me-6 text-muted">{{ labels('admin_labels.enable_disable_bracket', '[Enable/Disable]') }}</label>
                                        <div class="aurora-toggle">
                                            <input type="checkbox" id="" name="cod_allowed" {{ isset($data->cod_allowed) && $data->cod_allowed == '1' ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="aurora-toggle">
                                            <input type="checkbox" id="" name="is_returnable" {{ isset($data->is_returnable) && $data->is_returnable == '1' ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select type="text"
                                                            ...
                                                            <option value="1" {{ $data->stock_type != null && $data->availability == '1' ? 'selected' : '' }}>
                                                                {{ labels('admin_labels.in_stock_option', 'En stock') }}
                                                            </option>
                ...
                <div class="aurora-card"><div class="aurora-card-body" style="padding:5 mt-md-4">
