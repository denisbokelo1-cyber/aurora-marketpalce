...
@section('title')
    {{ labels('admin_labels.sliders', 'Bannières') }}
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.sliders', 'Bannières')" :subtitle="labels(
    ...
    )" :breadcrumbs="[['label' => labels('admin_labels.sliders', 'Bannières')]]" />
                    ...
                    <div class="aurora-card-body">
                        ...
                        <div id="type_add_html">
                            ...
                            <div class="form-group slider-url d-none">
                                ...
                                <input type="text" class="aurora-input" placeholder="{{ labels('admin_labels.example_url_placeholder', 'https://example.com') }}" name="link"
                                    value="">
                            </div>
                            <div class="form-group row slider-products d-none">
                                <label for="product_id" class="mb-2">{{ labels('admin_labels.products', 'Produits') }}
                                    <span class='text-asterisks text-sm'>*</span></label>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                    ...
                                    <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_slider_table"><i
