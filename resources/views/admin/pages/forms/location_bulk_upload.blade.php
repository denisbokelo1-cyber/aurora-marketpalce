                ...
                <form class="form-horizontal" action="{{ route('location.bulk_upload') }}" method="POST"
                    ...
                    <div class="aurora-card-body">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-3">
                            <button type="reset"
                                class="aurora-btn aurora-btn-secondary">{{ labels('admin_labels.reset', 'Réinitialiser') }}</button>
                            <button type="submit"
                                class="aurora-btn aurora-btn-primary">{{ labels('admin_labels.submit', 'Enregistrer') }}</button>
                        </div>
