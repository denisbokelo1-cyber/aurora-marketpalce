            ...
            <form id="general_setting_form" action="{{ route('pwa_settings.store') }}" class="submit_form"
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label class="form-label mb-3 mt-3" for="name">{{ labels('admin_labels.name', 'Nom') }}
                            <span class='text-asterisks text-xs'>*</span>
                        </label>
                        <input type="text" class="aurora-input" name="name"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="aurora-input" name="short_name"
                ...
                <div class="row">
                    <div class="mb-3 col-md-12">
                        ...
                        <textarea name="description" class="aurora-input" placeholder="{{ labels('admin_labels.write_here_your_description', 'Write here your description') }}">{{ old('description') }}{{ !empty($pwa_settings['description']) ? $pwa_settings['description'] : '' }}</textarea>
                    </div>
                </div>
                                ...
                                <div class="file_upload_box border file_upload_border mt-4">
                                    <div class="mt-2 text-center">
                                        <a class="media_link" data-input="logo" data-isremovable="0"
                                            ...
                                            <h4><i class='bx bx-upload'></i> {{ labels('admin_labels.upload', 'Télécharger') }}</h4>
                                        </a>
