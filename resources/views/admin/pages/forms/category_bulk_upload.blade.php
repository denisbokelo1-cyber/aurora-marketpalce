                    ...
                    <div class="aurora-card-body">
                        ...
                        <div class="mb-3">
                            <label for="type" class="form-label fw-medium">
                                ...
                                <small class="aurora-text-muted">{{ labels('admin_labels.upload_update_hint', '[upload/update]') }}</small>
                                <span class="text-danger">*</span>
                            </label>
                            <select class="aurora-input" name="type" id="type" >
                                <option value="">{{ labels('admin_labels.select', 'Sélectionner') }}</option>
                                <option value="upload">{{ labels('admin_labels.upload', 'Télécharger') }}</option>
                                <option value="update">{{ labels('admin_labels.update', 'Mettre à jour') }}</option>
                            </select>
                        </div>
