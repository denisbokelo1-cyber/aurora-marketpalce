                        ...
                        <div class="row mt-2">
                            <form class="form-horizontal submit_form" action="{{ route('ticket_types.store') }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" class="aurora-input" placeholder="{{ labels('admin_labels.ticket_type_placeholder', 'Ticket Type') }}">
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_support_ticket_type_table"><i
