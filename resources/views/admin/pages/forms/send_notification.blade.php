                        ...
                        <div class="aurora-card-body">
                            ...
                            <div id="type_add_html">
                                <div class="form-group notification-categories d-none">
                                    <label for="category_id">{{ labels('admin_labels.categories', 'Catégories') }}
                                        <span class='text-asterisks text-sm'>*</span>
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                ...
                                <div class="form-group row notification-products d-none">
                                    <label for="product_id"
                                        class="col-md-12 control-label">{{ labels('admin_labels.products', 'Produits') }}
                                        <span class='text-asterisks text-sm'>*</span>
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="aurora-input" name="title" id="title"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name='message' class="aurora-input"></textarea>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-switch notification-switch">
                                            <input type="checkbox" id="image_checkbox"
                                                name="image_checkbox">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_notification_table"><i
