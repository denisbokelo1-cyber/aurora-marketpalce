...
@section('content')
                            ...
                            <form class="form-horizontal form-submit-event submit_form"
                                ...
                                <div class="row">
                                    <div class="mb-3 col-lg-6 col-md-12 ">
                                        <label
                                            class="form-label">{{ !trans()->has('admin_labels.name') ? 'Nom' : trans('admin_labels.name') }}<span
                                                class='text-asterisks text-sm'>*</span></label>
                                        <input type="text" class="aurora-input" placeholder="" name="name"
                                            value="{{ old('name') }}">
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-12 ">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="aurora-input" id="phone" name="mobile" maxlength="16"
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-12 ">
                                        <label
                                            class="form-label">{{ !trans()->has('admin_labels.email') ? 'Email' : trans('admin_labels.email') }}<span
                                                class='text-asterisks text-sm'>*</span></label>
                                        <input type="text" class="aurora-input" placeholder="" name="email"
                                            value="{{ old('email') }}">
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-12 ">
                                        <label
                                            class="form-label">{{ !trans()->has('admin_labels.address') ? 'Address' : trans('admin_labels.address') }}<span
                                                class='text-asterisks text-sm'>*</span></label>
                                        <textarea type="text" class="aurora-input" placeholder="" name="address"
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-12  fixed_amount_per_order_item d-none">
                                        <label
                                            class="form-label">{{ !trans()->has('admin_labels.bonus_amount') ? 'Bonus Amount' : trans('admin_labels.bonus_amount') }}<span
                                                class='text-asterisks text-sm'>*</span></label>
                                        <input type="number" min=0 class="aurora-input"
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-12  percentage_per_order_item d-none">
                                        <label
                                            class="form-label">{{ !trans()->has('admin_labels.bonus_percentage') ? 'Bonus Percentage' : trans('admin_labels.bonus_percentage') }}<span
                                                class='text-asterisks text-sm'>*</span></label>
                                        <input type="number" class="aurora-input" min=1 max=100
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    <button type="reset"
                                        class="btn mx-2 reset_button">{{ !trans()->has('admin_labels.reset') ? 'Réinitialiser' : trans('admin_labels.reset') }}</button>
                                    <button type="submit"
    ...
    <div class="aurora-modal-overlay" style="display:none" id="fund_transfer_delivery_boy" tabindex="-1" role="dialog"
                ...
                <form class="form-horizontal submit_form" action="/admin/fund_transfer/add_fund_transfer" method="POST"
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="name"
                                class="col-sm-2 col-form-label">{{ labels('admin_labels.name', 'Nom') }}</label>

                            <input type="text" class="aurora-input" id="name" name="name" readonly>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" maxlength="16" oninput="validateNumberInput(this)" class="aurora-input"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="aurora-input" id="balance" min=1 name="balance" readonly>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" min='1' class="aurora-input" id="transfer_amt" name="transfer_amt">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="aurora-input" id="message" name="message">

                        </div>
                        <div class="d-flex justify-content-end">
                            <button type="submit"
                                class="aurora-btn aurora-btn-primary">{{ labels('admin_labels.fund_transfer', 'Fund Transfer') }}</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="aurora-modal-overlay" style="display:none" id="edit_delivery_boy" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                    ...
                    <form class="form-horizontal form-submit-event submit_form" action="" method="POST"
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="" class="form-label">{{ labels('admin_labels.name', 'Nom') }}<span
                                        class='text-asterisks text-sm'>*</span></label>
                                <input type="text" class="aurora-input" id="name" placeholder="" name="name" value="">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <select class="aurora-input" id="edit_country_code" name="country_code"
                                        style="max-width: 90px;">
                                    ...
                                    <input type="text" class="aurora-input" id="edit_phone" name="mobile" maxlength="16"
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="" class="form-label">{{ labels('admin_labels.email', 'Email') }}<span
                                        class='text-asterisks text-sm'>*</span></label>
                                <input type="text" class="aurora-input" id="email" placeholder="" name="email" value="">
                        ...
                        <div class="d-flex justify-content-end ">
                            <button type="reset"
                                class="btn reset-btn mx-2">{{ labels('admin_labels.reset', 'Réinitialiser') }}</button>
                            <button type="submit"
                                class="aurora-btn aurora-btn-primary">{{ labels('admin_labels.update_delivery_boy', 'Update Delivery Boy') }}
                            </button>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex justify-content-end ">
                            <div class="input-group me-2 search-input-grp ">
                                ...
                                <input type="text" data-table="admin_delivery_boys_table" class="aurora-input" style="max-width:200px;display:inline-block"
                            ...
                            <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_delivery_boys_table"><i
