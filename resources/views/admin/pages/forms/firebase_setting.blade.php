            ...
            <form id="general_setting_form" action="{{ route('firebase_settings.store') }}" class="submit_form"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="aurora-input" name="google_client_id"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="aurora-input" name="google_client_secret"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="aurora-input" name="google_redirect_url"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="aurora-input" name="facebook_client_id"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="aurora-input" name="facebook_client_secret"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="aurora-input" name="facebook_redirect_url"
