...
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.blog_categories', 'Blog Categories')" :subtitle="labels(
        ...
        ['label' => labels('admin_labels.categories', 'Catégories')],
    ]" />
                                            ...
                                            <div class="" id="content-en" role="tabpanel"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="name" class="aurora-input"
                                                        placeholder="{{ labels('admin_labels.name_placeholder', 'Nom') }}" value="">
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-end ">
                                        ...
                                        <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_blog_category_table"><i
