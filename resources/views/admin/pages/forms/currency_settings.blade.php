                    ...
                    <form id="" action="{{ route('currency_setting.store') }}" class="submit_form"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name" class="aurora-input" id="name"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="symbol" class="aurora-input" id="symbol" placeholder="₹">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="code" class="aurora-input" id="code" placeholder="{{ labels('admin_labels.placeholder_inr', 'inr') }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="">
                                ...
                                <input type="number" min="0" max="1000000" name="exchange_rate" step="0.00000001"
                                    class="aurora-input" id="exchange_rate" placeholder="80">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="d-flex justify-content-end flex-wrap gap-10">
                                    <button type="submit"
                                        class="aurora-btn aurora-btn-primary">{{ labels('admin_labels.save', 'Enregistrer') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="aurora-modal-overlay" style="display:none" id="currency_detail_modal" tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="aurora-modal-footer">
                                                        <button type="button" class="aurora-btn aurora-btn-secondary"
                                                            data-bs-dismiss="modal">{{ labels('admin_labels.close_modal', 'Fermer') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <input type="text" name="exchange_rate_app_id" class="aurora-input"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" method="POST" class="submit_form">
                    ...
                    <div class="aurora-modal-body" role="document">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="">
                                    {{ labels('admin_labels.currency_name', 'Currency Name') }}
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                                ...
                                <a class="aurora-toolbar-btn" id="tableRefresh" data-table="admin_currency_table"><i
