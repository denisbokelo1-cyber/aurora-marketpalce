...
@section('title')
    {{ labels('admin_labels.offers', 'Offres') }}
@endsection
@section('content')
    <x-admin.breadcrumb :title="labels('admin_labels.offers', 'Offres')" :subtitle="labels(
    ...
    )" :breadcrumbs="[['label' => labels('admin_labels.offers', 'Offres')]]" />
                        ...
                        <div class="aurora-card-body">
                            ...
                            <div class="tab-content mt-3" id="brandTabsContent">
                                <div class="" id="content-en" role="tabpanel"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="{{ labels('admin_labels.best_deals', 'Best Deals') }}" name="title" class="aurora-input"
                                            value="{{ old('title') }}">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" id="offer_type" class="form-select form-control type_event_trigger"
                                    ...
                                    <option value="default">{{ labels('admin_labels.default_theme', 'Par défaut') }}</option>
                            ...
                            <div id="type_add_html">
                                ...
                                <div class="form-group offer-url d-none mt-4">
                                    <label for="slider_url" class="mb-2">
                                        ...
                                        <span class='text-asterisks text-sm'>*</span></label>
                                    <input type="text" class="aurora-input" placeholder="{{ labels('admin_labels.example_url_placeholder', 'https://example.com') }}"
                                        name="link" value="">
                                </div>
                                <div class="form-group row slider-products d-none mt-4">
                                    <label for="product_id"
                                        class="control-label mb-2">{{ labels('admin_labels.products', 'Produits') }}
                                        <span class='text-asterisks text-sm'>*</span></label>
                            ...
                            <div class="form-group row offer_discount d-none mt-4" id="min_max_section">
                                <div class="form-group col-md-6">
                                    <label
                                        ...
                                        <span class='text-asterisks text-sm'>*</span></label>
                                    <input type="number" class="aurora-input" name="min_discount" id="min_discount"
                                        min=1 max=100 value="">
                                </div>
                                <div class="form-group col-md-6">
                                    <label
                                        ...
                                        <span class='text-asterisks text-sm'>*</span></label>
                                    <input type="number" class="aurora-input" name="max_discount" max=100
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end ">
                                <div class="input-group me-2 search-input-grp ">
                                    ...
                                    <input type="text" data-table="admin_offer_table" class="aurora-input" style="max-width:200px;display:inline-block"
                                ...
                                <a class="aurora-toolbar-btn" id="tableRefresh"data-table="admin_offer_table"><i
