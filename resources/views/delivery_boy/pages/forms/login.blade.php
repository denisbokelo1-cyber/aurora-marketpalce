<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" type="image/png"
            href="{{ !empty($system_settings) && isset($system_settings['favicon']) ? app(MediaService::class)->getMediaImageUrl($system_settings['favicon']) : asset('assets/img/favicon.png') }}">
        <title>{{ labels('panel_labels.login', 'Login') }} | {{ $system_settings['app_name'] ?? 'eShop' }}</title>
                ...
                <div class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <div class="login-img-box mb-3">
                                    <img src="{{ config('app.url') }}storage/{{ $system_settings['logo'] ?? 'logo.png' }}"
                    ...
                    <div class="copyright mt-4">
                        {{ labels('panel_labels.copyright', 'Copyright') }} © {{ date('Y') }} <a
                            href="{{ config('app.url') . 'admin/home' }}">{{ $system_settings['app_name'] ?? 'eShop' }}.</a>
